...
bedspace_gaps_and_days as (select distinct
                            ...
                            turnaround_days
                        from bedspace_gaps
                        left join bedspace_bookings on (upper(gap) = arrival_date or lower(gap) = departure_date) and  bedspace_gaps.premises_name =  bedspace_bookings.premises_name and bedspace_gaps.room_name = bedspace_bookings.room_name)
