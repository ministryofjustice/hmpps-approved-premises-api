...
interface PremisesCas1 {
  ...
  fun getDelegate(): uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.PremisesCas1Delegate = object :
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = Cas1PremiseCapacity::class))],
      ),
      ApiResponse(
        responseCode = "400",
  ...
  fun getCapacity(
    ...
    @Parameter(
      ...
      value = "startDate",
      required = true,
    ) @org.springframework.format.annotation.DateTimeFormat(iso = org.springframework.format.annotation.DateTimeFormat.ISO.DATE) startDate: java.time.LocalDate,
    @Parameter(description = "End date, inclusive", required = true) @RequestParam(
      value = "endDate",
      required = true,
    ) @org.springframework.format.annotation.DateTimeFormat(iso = org.springframework.format.annotation.DateTimeFormat.ISO.DATE) endDate: java.time.LocalDate,
    @Parameter(description = "ID of a booking to exclude from capacity calculations") @RequestParam(
      value = "excludeSpaceBookingId",
      required = false,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = Cas1PremisesDaySummary::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun getDaySummary(
    ...
    @Parameter(
      ...
      required = true,
    ) @PathVariable("date") date: java.time.LocalDate,
    @Parameter(description = "If provided, will only show bookings with matching criteria") @RequestParam(
      value = "bookingsCriteriaFilter",
      required = false,
    ...
    ) @RequestParam(value = "bookingsSortDirection", required = false) bookingsSortDirection: SortDirection?,
    @Parameter(
      description = "The field to sort the booking by. If not defined, will sort on person name",
      schema = Schema(allowableValues = ["personName", "tier", "canonicalArrivalDate", "canonicalDepartureDate", "releaseType"]),
    ) @RequestParam(value = "bookingsSortBy", required = false) bookingsSortBy: Cas1SpaceBookingDaySummarySortField?,
  ): ResponseEntity<Cas1PremisesDaySummary> {
    return getDelegate().getDaySummary(
      premisesId,
      date,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = Cas1Premises::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = Cas1PremisesBasicSummary::class)))],
      ),
      ApiResponse(
        responseCode = "400",
        description = "invalid params",
  ...
  fun getPremisesSummaries(
    @Parameter(
      ...
      schema = Schema(allowableValues = ["man", "woman"]),
    ) @RequestParam(value = "gender", required = false) gender: Cas1ApprovedPremisesGender?,
