...
interface CAS2EventsApi {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = Cas2ApplicationStatusUpdatedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas2ApplicationStatusUpdatedEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<Cas2ApplicationStatusUpdatedEvent> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = Cas2ApplicationSubmittedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas2ApplicationSubmittedEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<Cas2ApplicationSubmittedEvent> {
