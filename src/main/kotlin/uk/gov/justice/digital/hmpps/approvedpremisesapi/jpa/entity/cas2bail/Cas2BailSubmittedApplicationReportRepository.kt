...
@Repository
interface Cas2BailSubmittedApplicationReportRepository : JpaRepository<DomainEventEntity, UUID> {
  @Query(
    """
      SELECT
      ...
      JOIN cas_2_bail_applications applications
  ...
  fun generateSubmittedApplicationReportRows(): List<Cas2BailSubmittedApplicationReportRow>
}

@SuppressWarnings("TooManyFunctions")
interface Cas2BailSubmittedApplicationReportRow {
  fun getId(): String
