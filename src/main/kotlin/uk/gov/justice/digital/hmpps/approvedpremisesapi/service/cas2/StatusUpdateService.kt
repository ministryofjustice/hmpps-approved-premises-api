...
class StatusUpdateService(
  ...
  fun create(
    ...
    createStatusUpdatedDomainEvent(createdStatusUpdate, application, statusDetails)
  ...
  fun createForAssessment(
    ...
    createStatusUpdatedDomainEvent(createdStatusUpdate, assessment.application, statusDetails)
