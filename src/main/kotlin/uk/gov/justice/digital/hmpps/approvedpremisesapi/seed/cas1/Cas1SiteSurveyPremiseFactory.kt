...
class Cas1SiteSurveyPremiseFactory {
  ...
  private fun DataFrame<*>.toInternalModel(): Cas1SiteSurveyPremise {
    ...
    return Cas1SiteSurveyPremise(
      ...
      cateredOrSelfCatered = resolveAnswer("Is this AP Catered or Self Catering?").dropDownToCatering(),
      ...
      hasAHearingLoop = resolveAnswer("Does this AP have a hearing loop?").dropDownYesNoToBoolean(),
  ...
  private fun String.dropDownToCatering() = if (this == "Catered") {
    Catering.CATERED
  } else {
    Catering.SELF_CATERED
  }
...
data class Cas1SiteSurveyPremise(
  ...
  val cateredOrSelfCatered: Catering,
...
enum class SiteSurveyProbationRegion {
  ...
  YORKS_AND_HUMBER, // Yorkshire & The Humber
