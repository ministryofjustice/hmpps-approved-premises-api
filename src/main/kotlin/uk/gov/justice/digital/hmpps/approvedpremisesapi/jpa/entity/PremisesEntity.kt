...
interface PremisesRepository : JpaRepository<PremisesEntity, UUID> {
  ...
  fun findAllCas3PremisesSummary(regionId: UUID, postcodeOrAddress: String?, postcodeOrAddressWithoutWhitespace: String?, propertyStatus: Cas3PropertyStatus? = null): List<TemporaryAccommodationPremisesSummary>
