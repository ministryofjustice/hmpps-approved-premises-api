 ...
 */
@jakarta.annotation.Generated(value = ["org.openapitools.codegen.languages.KotlinSpringServerCodegen"], comments = "Generator version: 7.13.0")interface OAsysCas1Delegate {
     ...
     */
    fun answers(crn: kotlin.String,
        group: Cas1OASysGroupName,
        includeOptionalSections: kotlin.collections.List<kotlin.Int>?): ResponseEntity<Cas1OASysGroup> {
