      ...
      for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
          ApiUtil.setExampleResponse(
            request,
            "application/json",
            "{  \"eventDetails\" : {    \"updatedStatus\" : \"updatedStatus\",    \"applicationId\" : \"484b8b5e-6c3b-4400-b200-425bbe410713\",    \"previousStatus\" : \"previousStatus\"  },  \"id\" : \"364145f9-0af8-488e-9901-b4c46cd9ba37\",  \"eventType\" : \"approved-premises.application.submitted\",  \"timestamp\" : \"2000-01-23T04:56:07.000+00:00\"}",
          )
          break
        }
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
