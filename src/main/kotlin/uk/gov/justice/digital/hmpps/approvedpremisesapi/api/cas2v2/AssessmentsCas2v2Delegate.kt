      ...
      for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
            uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas2v2.ApiUtil.setExampleResponse(
                request,
                "application/json",
                "{  \"createdAt\" : \"2000-01-23T04:56:07.000+00:00\",  \"name\" : \"Roger Smith\",  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"body\" : \"body\",  \"email\" : \"roger@example.com\"}",
            )
          break
        }
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
