...
class PremisesCas1Controller(
    delegate: uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.PremisesCas1Delegate?,
) : PremisesCas1 {
  private lateinit var delegate: uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.PremisesCas1Delegate
  ...
  override fun getDelegate(): uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.PremisesCas1Delegate = delegate
}
