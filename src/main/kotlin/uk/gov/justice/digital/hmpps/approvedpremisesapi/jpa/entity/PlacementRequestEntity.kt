...
interface PlacementRequestRepository : JpaRepository<PlacementRequestEntity, UUID> {
  ...
  @Query(
    """
      SELECT
      pq.duration AS placementDatesDuration,
      pq.expected_arrival AS placementDatesExpectedArrivalDate,
      pq.id AS id,
      application.crn AS personCrn,
      apa.risk_ratings -> 'tier' -> 'value' ->> 'level' AS personRiskTierEnvelopeValueLevel,
      ...
      application.submitted_at::date AS applicationDate,
...
interface Cas1PlacementRequestSummary {
  fun getPlacementDatesDuration(): Int
  fun getPlacementDatesExpectedArrivalDate(): LocalDate
  fun getId(): UUID
  fun getPersonCrn(): String
  fun getPersonRiskTierEnvelopeValueLevel(): String
  fun getApplicationId(): UUID
  fun getPlacementRequestStatus(): String
  fun getApplicationDate(): LocalDate
