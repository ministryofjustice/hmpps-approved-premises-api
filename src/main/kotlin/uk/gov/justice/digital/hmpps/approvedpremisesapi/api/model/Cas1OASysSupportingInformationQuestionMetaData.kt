...
data class Cas1OASysSupportingInformationQuestionMetaData(
  ...
  @get:JsonProperty("section", required = true) val section: Int,

  @get:JsonProperty("sectionLabel", required = true) val sectionLabel: String,
  ...
  @get:JsonProperty("inclusionOptional", required = true) val inclusionOptional: Boolean,
  ...
  @get:JsonProperty("oasysAnswerLinkedToHarm") val oasysAnswerLinkedToHarm: Boolean? = null,
  ...
  @get:JsonProperty("oasysAnswerLinkedToReOffending") val oasysAnswerLinkedToReOffending: Boolean? = null,
)
