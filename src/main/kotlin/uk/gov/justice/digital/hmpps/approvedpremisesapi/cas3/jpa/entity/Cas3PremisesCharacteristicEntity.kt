...
@Repository
interface Cas3PremisesCharacteristicRepository :
  JpaRepository<Cas3PremisesCharacteristicEntity, UUID>,
  ReferenceDataRepository<Cas3PremisesCharacteristicEntity> {
  ...
  override fun findAllByActiveIsTrue(): List<Cas3PremisesCharacteristicEntity>
