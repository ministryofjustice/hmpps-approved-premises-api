...
data class Cas1PremiseCharacteristicAvailability(
  ...
  @field:Schema(example = "null", required = true, description = "the number of available beds with this characteristic")
  @get:JsonProperty("availableBedsCount", required = true) val availableBedsCount: kotlin.Int,

  @field:Schema(example = "null", required = true, description = "the number of bookings requiring this characteristic")
