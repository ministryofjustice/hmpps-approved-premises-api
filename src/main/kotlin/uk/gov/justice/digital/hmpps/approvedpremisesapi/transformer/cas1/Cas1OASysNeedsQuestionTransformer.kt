...
class Cas1OASysNeedsQuestionTransformer {
  ...
  private fun toQuestionState(needsDetails: NeedsDetails) = listOf(
    QuestionState(
      ...
      questionNumber = "3.9",
      questionLabel = OASysLabels.questionToLabel["3.9"]!!,
    ...
    QuestionState(
      ...
      questionNumber = "6.9",
      questionLabel = OASysLabels.questionToLabel["6.9"]!!,
    ...
    QuestionState(
      ...
      questionNumber = "7.9",
      questionLabel = OASysLabels.questionToLabel["7.9"]!!,
    ...
    QuestionState(
      ...
      questionNumber = "8.9",
      questionLabel = OASysLabels.questionToLabel["8.9"]!!,
    ...
    QuestionState(
      ...
      questionNumber = "9.9",
      questionLabel = OASysLabels.questionToLabel["9.9"]!!,
    ...
    QuestionState(
      ...
      questionNumber = "10.9",
      questionLabel = OASysLabels.questionToLabel["10.9"]!!,
    ...
    QuestionState(
      ...
      questionNumber = "11.9",
      questionLabel = OASysLabels.questionToLabel["11.9"]!!,
    ...
    QuestionState(
      ...
      questionNumber = "12.9",
      questionLabel = OASysLabels.questionToLabel["12.9"]!!,
