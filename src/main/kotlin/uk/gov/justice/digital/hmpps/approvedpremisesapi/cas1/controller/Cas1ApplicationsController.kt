...
class Cas1ApplicationsController(
  ...
  fun createEligibleApplication(
    ...
    val outcome = extractEntityFromCasResult(cas1ApplicationCreationService.createApprovedPremisesEligibleApplication(
      crn,
      user,
      body.convictionId,
      body.deliusEventNumber,
    ...
    return ResponseEntity
      .created(URI.create("/cas1/applications/${outcome.applicationId}"))
      .body(outcome)
  }
