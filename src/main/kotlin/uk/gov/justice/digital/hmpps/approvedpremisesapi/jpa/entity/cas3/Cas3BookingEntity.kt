...
interface Cas3v2BookingRepository : JpaRepository<Cas3BookingEntity, UUID> {
  @Query(
    """
      ...
      AND (CAST(:bookingId as org.hibernate.type.UUIDCharType) IS NULL OR b.id != :bookingId)
    """,
  )
  fun findByBedspaceIdAndArrivingBeforeDate(bedspaceId: UUID, date: LocalDate, bookingId: UUID?): List<Cas3BookingEntity>
