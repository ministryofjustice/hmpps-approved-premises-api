...
interface ReferenceDataApi {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(array = ArraySchema(schema = Schema(implementation = ApArea::class)))],
      ),
      ApiResponse(
        responseCode = "401",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = CancellationReason::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun referenceDataCharacteristicsGet(
    ...
    @Parameter(
      description = "",
      schema = Schema(allowableValues = ["PREMISES", "BEDSPACE", "ROOM"]),
    ) @RequestParam(
      value = "modelScope",
      required = false,
  ...
  fun referenceDataDepartureReasonsGet(
    ...
    @Parameter(description = "Specifies whether inactive departure reasons should be provided. Defaults to `false`.") @RequestParam(
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = DestinationProvider::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = LocalAuthorityArea::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = LostBedReason::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun referenceDataMoveOnCategoriesGet(
    ...
    @Parameter(description = "Specifies whether inactive move-on categories should be provided. Defaults to `false`.") @RequestParam(
      value = "includeInactive",
      required = false,
    ) includeInactive: kotlin.Boolean?,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = ProbationDeliveryUnit::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun referenceDataProbationDeliveryUnitsGet(
    @Parameter(description = "If given, only probation delivery units for this region will be returned") @RequestParam(
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = ProbationRegion::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = ReferralRejectionReason::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = SupervisingOfficer::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = SupervisingProvider::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = SupervisingTeam::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
