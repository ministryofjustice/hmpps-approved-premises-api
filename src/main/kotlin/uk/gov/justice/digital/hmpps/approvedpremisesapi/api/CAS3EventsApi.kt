...
interface CAS3EventsApi {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3BookingCancelledEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas3BookingCancelledEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<CAS3BookingCancelledEvent> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3BookingCancelledUpdatedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas3BookingCancelledUpdatedEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<CAS3BookingCancelledUpdatedEvent> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3BookingConfirmedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas3BookingConfirmedEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<CAS3BookingConfirmedEvent> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3BookingProvisionallyMadeEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas3BookingProvisionallyMadeEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<CAS3BookingProvisionallyMadeEvent> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3PersonArrivedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
        description = "No 'person-arrived' event found for the provided `eventId`",
  ...
  fun eventsCas3PersonArrivedEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<CAS3PersonArrivedEvent> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3PersonArrivedUpdatedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas3PersonArrivedUpdatedEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<CAS3PersonArrivedUpdatedEvent> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3PersonDepartedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3PersonDepartureUpdatedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas3PersonDepartureUpdatedEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<CAS3PersonDepartureUpdatedEvent> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = CAS3ReferralSubmittedEvent::class))],
      ),
      ApiResponse(
        responseCode = "404",
  ...
  fun eventsCas3ReferralSubmittedEventIdGet(
    @Parameter(
      description = "UUID of the event",
      required = true,
    ) @PathVariable("eventId") eventId: java.util.UUID,
  ): ResponseEntity<CAS3ReferralSubmittedEvent> {
