...
data class PlacementApplicationWithdrawn(
  ...
  @Schema(example = "When this domain event was first defined a placement application could have multiple dates. For that reason we need to retain this list for rendering old events on the timeline")
