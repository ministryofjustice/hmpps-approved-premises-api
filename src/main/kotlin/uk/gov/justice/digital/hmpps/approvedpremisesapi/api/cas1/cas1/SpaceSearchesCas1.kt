...
interface SpaceSearchesCas1 {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = Cas1SpaceSearchResults::class))],
      ),
      ApiResponse(
        responseCode = "400",
  ...
  fun spaceSearch(
    @Parameter(
      description = "",
      required = true,
    ) @RequestBody cas1SpaceSearchParameters: Cas1SpaceSearchParameters,
  ): ResponseEntity<Cas1SpaceSearchResults> {
