...
interface OutOfServiceBedsCas1 {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = Cas1OutOfServiceBedCancellation::class))],
      ),
      ApiResponse(
        responseCode = "400",
  ...
  fun cancelOutOfServiceBed(
    ...
    @Parameter(
      ...
      required = true,
    ) @PathVariable("outOfServiceBedId") outOfServiceBedId: java.util.UUID,
    @Parameter(
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = Cas1OutOfServiceBed::class))],
      ),
      ApiResponse(
        responseCode = "400",
        description = "invalid params",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = Cas1OutOfServiceBed::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun getOutOfServiceBeds(
    @Parameter(description = "If provided, restrict the results to only those with the given temporality/ies.") @RequestParam(
      value = "temporality",
      required = false,
    ) temporality: kotlin.collections.List<Temporality>?,
    @Parameter(description = "If provided, restrict the results to only those in the premises with the given ID.") @RequestParam(
      value = "premisesId",
      required = false,
    ) premisesId: java.util.UUID?,
    @Parameter(description = "If provided, restrict the results to only those within the AP area with the given ID.") @RequestParam(
      value = "apAreaId",
      required = false,
    ...
    @Parameter(
      ...
      schema = Schema(allowableValues = ["premisesName", "roomName", "bedName", "startDate", "endDate", "reason", "daysLost"]),
    ) @RequestParam(value = "sortBy", required = false) sortBy: Cas1OutOfServiceBedSortField?,
    ...
    return getDelegate().getOutOfServiceBeds(
      temporality,
      premisesId,
      apAreaId,
      sortDirection,
