 ...
 */
@jakarta.annotation.Generated(value = ["org.openapitools.codegen.languages.KotlinSpringServerCodegen"], comments = "Generator version: 7.13.0")interface SpaceBookingsCas1Delegate {

    fun getRequest(): Optional<NativeWebRequest> = Optional.empty()

    /**
     * @see SpaceBookingsCas1#appeal
     */
    fun appeal(premisesId: java.util.UUID,
        bookingId: java.util.UUID,
        body: Cas1ApprovedPlacementAppeal): ResponseEntity<Unit> {
    ...
    /**
     * @see SpaceBookingsCas1#emergencyTransfer
     */
    fun emergencyTransfer(premisesId: java.util.UUID,
        bookingId: java.util.UUID,
        cas1NewEmergencyTransfer: Cas1NewEmergencyTransfer): ResponseEntity<Unit> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/problem+json"))) {
                            ApiUtil.setExampleResponse(request, "application/problem+json", "Custom MIME type example not yet supported: application/problem+json")
    ...
    fun getSpaceBookingTimeline(premisesId: java.util.UUID,
        bookingId: java.util.UUID): ResponseEntity<List<Cas1TimelineEvent>> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    fun getSpaceBookings(premisesId: java.util.UUID,
        ...
        perPage: kotlin.Int?): ResponseEntity<List<Cas1SpaceBookingSummary>> {
                    ...
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                            ApiUtil.setExampleResponse(request, "application/json", "[ {  \"actualArrivalDate\" : \"2000-01-23\",  \"characteristics\" : [ null, null ],  \"isCancelled\" : true,  \"canonicalArrivalDate\" : \"2000-01-23\",  \"canonicalDepartureDate\" : \"2000-01-23\",  \"openChangeRequestTypes\" : [ \"placementAppeal\", \"placementAppeal\" ],  \"deliusEventNumber\" : \"deliusEventNumber\",  \"isNonArrival\" : true,  \"expectedDepartureDate\" : \"2000-01-23\",  \"keyWorkerAllocation\" : {    \"keyWorker\" : {      \"code\" : \"code\",      \"keyWorker\" : true,      \"name\" : \"Brown, James (PS - PSO)\"    },    \"allocatedAt\" : \"2000-01-23\"  },  \"tier\" : \"tier\",  \"expectedArrivalDate\" : \"2000-01-23\",  \"person\" : {    \"personType\" : \"FullPersonSummary\",    \"crn\" : \"crn\"  },  \"premises\" : {    \"name\" : \"name\",    \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"  },  \"appealRequested\" : true,  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"actualDepartureDate\" : \"2000-01-23\",  \"plannedTransferRequested\" : true,  \"status\" : \"arrivingWithin6Weeks\"}, {  \"actualArrivalDate\" : \"2000-01-23\",  \"characteristics\" : [ null, null ],  \"isCancelled\" : true,  \"canonicalArrivalDate\" : \"2000-01-23\",  \"canonicalDepartureDate\" : \"2000-01-23\",  \"openChangeRequestTypes\" : [ \"placementAppeal\", \"placementAppeal\" ],  \"deliusEventNumber\" : \"deliusEventNumber\",  \"isNonArrival\" : true,  \"expectedDepartureDate\" : \"2000-01-23\",  \"keyWorkerAllocation\" : {    \"keyWorker\" : {      \"code\" : \"code\",      \"keyWorker\" : true,      \"name\" : \"Brown, James (PS - PSO)\"    },    \"allocatedAt\" : \"2000-01-23\"  },  \"tier\" : \"tier\",  \"expectedArrivalDate\" : \"2000-01-23\",  \"person\" : {    \"personType\" : \"FullPersonSummary\",    \"crn\" : \"crn\"  },  \"premises\" : {    \"name\" : \"name\",    \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"  },  \"appealRequested\" : true,  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"actualDepartureDate\" : \"2000-01-23\",  \"plannedTransferRequested\" : true,  \"status\" : \"arrivingWithin6Weeks\"} ]")
                            break
                        }
                    }
                }
    ...
    /**
     * @see SpaceBookingsCas1#plannedTransfer
     */
    fun plannedTransfer(premisesId: java.util.UUID,
        bookingId: java.util.UUID,
        cas1NewPlannedTransfer: Cas1NewPlannedTransfer): ResponseEntity<Unit> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/problem+json"))) {
                            ApiUtil.setExampleResponse(request, "application/problem+json", "Custom MIME type example not yet supported: application/problem+json")
    ...
    /**
     * @see SpaceBookingsCas1#shortenSpaceBooking
     */
    fun shortenSpaceBooking(premisesId: java.util.UUID,
        bookingId: java.util.UUID,
        cas1ShortenSpaceBooking: Cas1ShortenSpaceBooking): ResponseEntity<Unit> {
                        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
                    }
