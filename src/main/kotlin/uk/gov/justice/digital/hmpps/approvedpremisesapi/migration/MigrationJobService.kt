...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.cas2.migration.Cas2UserNomisMigrationJob
  ...
  fun runMigrationJob(migrationJobType: MigrationJobType, pageSize: Int = 10) {
    ...
    try {
      val job: MigrationJob = when (migrationJobType) {
        ...
        MigrationJobType.migrateNomisUsersToCas2UsersTable -> getBean(Cas2UserNomisMigrationJob::class)
      }
