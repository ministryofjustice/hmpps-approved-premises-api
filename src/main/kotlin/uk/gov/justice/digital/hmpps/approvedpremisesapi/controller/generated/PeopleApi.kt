...
interface PeopleApi {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(array = ArraySchema(schema = Schema(implementation = PersonAcctAlert::class)))],
      ),
      ApiResponse(
        responseCode = "401",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = Adjudication::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = OASysRiskToSelf::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun peopleCrnOasysRiskToSelfGet(
    @Parameter(
      description = "CRN of the Person to fetch latest OASys",
      required = true,
    ) @PathVariable("crn") crn: kotlin.String,
  ): ResponseEntity<OASysRiskToSelf> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = OASysRiskOfSeriousHarm::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun peopleCrnOasysRoshGet(
    @Parameter(
      description = "CRN of the Person to fetch latest OASys",
      required = true,
    ) @PathVariable("crn") crn: kotlin.String,
  ): ResponseEntity<OASysRiskOfSeriousHarm> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = OASysSections::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun peopleCrnOasysSectionsGet(
    ...
    @Parameter(description = "Section numbers for optional (not Linked to Harm) suppprting information") @RequestParam(
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = OASysSection::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun peopleCrnOasysSelectionGet(
    @Parameter(
      description = "CRN of the Person to fetch latest OASys selection",
      required = true,
    ) @PathVariable("crn") crn: kotlin.String,
  ): ResponseEntity<List<OASysSection>> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = ActiveOffence::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = PrisonCaseNote::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = PersonRisks::class))],
      ),
      ApiResponse(
        responseCode = "400",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = PersonalTimeline::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun peopleCrnTimelineGet(
    @Parameter(
      description = "CRN of the Person to fetch the timeline for",
      required = true,
    ) @PathVariable("crn") crn: kotlin.String,
  ): ResponseEntity<PersonalTimeline> {
  ...
  fun peopleSearchGet(
    @Parameter(description = "CRN to search for", required = true) @RequestParam(
      value = "crn",
      required = true,
    ) crn: kotlin.String,
