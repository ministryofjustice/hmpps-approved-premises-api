...
SELECT DISTINCT ON (application.submitted_at, application.id)
  ...
  submission_event.data -> 'eventDetails' -> 'personTier' ->> 'tierScore' AS application_tier_on_submission,
  ...
  initial_assessment_event.data -> 'eventDetails' -> 'personTier' ->> 'tierScore' AS initial_assessment_decision_tier,
  ...
  latest_appeal_assessment_event.data -> 'eventDetails' -> 'personTier' ->> 'tierScore' AS last_appealed_assessment_tier,
