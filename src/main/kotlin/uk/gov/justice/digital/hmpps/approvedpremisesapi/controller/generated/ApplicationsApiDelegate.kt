...
interface ApplicationsApiDelegate {
  ...
  fun applicationsApplicationIdRequestsForPlacementRequestForPlacementIdGet(
    applicationId: java.util.UUID,
    requestForPlacementId: java.util.UUID,
      ...
      for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
          ApiUtil.setExampleResponse(
            request,
            "application/json",
            "[ {  \"dates\" : [ {    \"endDate\" : \"2000-01-23\",    \"startDate\" : \"2000-01-23\"  }, {    \"endDate\" : \"2000-01-23\",    \"startDate\" : \"2000-01-23\"  } ],  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"type\" : \"application\"}, {  \"dates\" : [ {    \"endDate\" : \"2000-01-23\",    \"startDate\" : \"2000-01-23\"  }, {    \"endDate\" : \"2000-01-23\",    \"startDate\" : \"2000-01-23\"  } ],  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"type\" : \"application\"} ]",
          )
          break
        }
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
