...
object Cas1NotifyTemplates {
  ...
  const val PLANNED_TRANSFER_REQUEST_REJECTED = "81ed7297-ecc4-4c32-9df4-02a54e4789c8"
  const val PLANNED_TRANSFER_REQUEST_ACCEPTED_FOR_REQUESTING_AP = "18cc4564-28a3-4f45-9a15-8bb7200bd7eb"
  const val PLANNED_TRANSFER_REQUEST_ACCEPTED_FOR_TARGET_AP = "3a455847-f4c4-4193-82e0-19510bf2c599"
  const val PLANNED_TRANSFER_REQUEST_CREATED = "32084a51-f2fc-45f8-8402-58fa2bb6905a"
...
object Cas2NotifyTemplates {
  ...
  const val CAS2_BAIL_APPLICATION_ASSESSOR_NOTE_ADDED = "0919a001-7b83-44c0-b0d0-a617d84012bb"
  const val CAS2_BAIL_APPLICATION_REFERRER_NOTE_ADDED = "71fd8007-87a0-49b8-9099-7919b6ca4716"
}
