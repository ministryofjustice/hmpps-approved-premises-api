...
class Cas3DomainEventService(
  ...
  @Transactional
  fun saveBedspaceArchiveEvent(bedspace: BedEntity, premisesId: UUID) {
    val user = userService.getUserForRequest()
    val domainEvent = cas3DomainEventBuilder.getBedspaceArchiveEvent(bedspace, premisesId, user)
