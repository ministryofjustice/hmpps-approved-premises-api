...
@Repository
interface Cas2BailApplicationStatusUpdatesReportRepository : JpaRepository<DomainEventEntity, UUID> {
  @Query(
    """
      SELECT
  ...
  fun generateApplicationStatusUpdatesReportRows(): List<Cas2BailApplicationStatusUpdatedReportRow>
}

interface Cas2BailApplicationStatusUpdatedReportRow {
  fun getId(): String
