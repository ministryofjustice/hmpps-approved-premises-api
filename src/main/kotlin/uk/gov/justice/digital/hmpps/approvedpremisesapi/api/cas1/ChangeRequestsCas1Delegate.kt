 ...
 */
@jakarta.annotation.Generated(value = ["org.openapitools.codegen.languages.KotlinSpringServerCodegen"], comments = "Generator version: 7.13.0")interface ChangeRequestsCas1Delegate {
     ...
     */
    fun createPlacementAppeal(placementRequestId: java.util.UUID,
        cas1NewChangeRequest: Cas1NewChangeRequest): ResponseEntity<Unit> {
     ...
     */
    fun createPlacementExtension(placementRequestId: java.util.UUID,
        cas1NewChangeRequest: Cas1NewChangeRequest): ResponseEntity<Unit> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/problem+json"))) {
     ...
     */
    fun createPlannedTransfer(placementRequestId: java.util.UUID,
        cas1NewChangeRequest: Cas1NewChangeRequest): ResponseEntity<Unit> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/problem+json"))) {
     ...
     */
    fun findOpen(page: kotlin.Int?,
        cruManagementAreaId: java.util.UUID?,
        sortBy: Cas1ChangeRequestSortField?,
        sortDirection: SortDirection?): ResponseEntity<List<Cas1ChangeRequestSummary>> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
     ...
     */
    fun get(placementRequestId: java.util.UUID,
        changeRequestId: java.util.UUID): ResponseEntity<Cas1ChangeRequest> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
     ...
     */
    fun reject(placementRequestId: java.util.UUID,
        changeRequestId: java.util.UUID,
        cas1RejectChangeRequest: Cas1RejectChangeRequest): ResponseEntity<Unit> {
                        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
                    }
