...
interface ChangeRequestsCas1Delegate {
     ...
     */
    fun find(status: Cas1ChangeRequestStatus?,
        page: kotlin.Int?,
        ...
        getRequest().ifPresent { request ->
            for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "[ {  \"resolved_at\" : \"2000-01-23T04:56:07.000+00:00\",  \"created_at\" : \"2000-01-23T04:56:07.000+00:00\",  \"type\" : \"appeal\",  \"resolution\" : \"approved\",  \"crn\" : \"crn\"}, {  \"resolved_at\" : \"2000-01-23T04:56:07.000+00:00\",  \"created_at\" : \"2000-01-23T04:56:07.000+00:00\",  \"type\" : \"appeal\",  \"resolution\" : \"approved\",  \"crn\" : \"crn\"} ]")
                    break
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"instance\" : \"f7493e12-546d-42c3-b838-06c12671ab5b\",  \"detail\" : \"You provided invalid request parameters\",  \"type\" : \"https://example.net/validation-error\",  \"title\" : \"Invalid request parameters\",  \"status\" : 400}")
