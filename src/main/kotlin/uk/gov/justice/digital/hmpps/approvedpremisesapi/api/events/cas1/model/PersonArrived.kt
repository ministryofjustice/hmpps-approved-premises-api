...
data class PersonArrived(
  ...
  @field:Schema(example = "Sun Aug 21 01:00:00 BST 2022", required = true, description = "")
  ...
  @field:Schema(example = "Tue Feb 28 00:00:00 GMT 2023", required = true, description = "")
  @get:JsonProperty("expectedDepartureOn", required = true) val expectedDepartureOn: java.time.LocalDate,

  @field:Schema(example = "Tue Feb 28 00:00:00 GMT 2023", description = "")
  @get:JsonProperty("previousExpectedDepartureOn") val previousExpectedDepartureOn: java.time.LocalDate? = null,

  @field:Schema(example = "Arrived a day late due to rail strike. Informed in advance by COM.", description = "")
