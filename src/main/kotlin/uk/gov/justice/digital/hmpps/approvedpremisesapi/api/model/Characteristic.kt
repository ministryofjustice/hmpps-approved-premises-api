...
data class Characteristic(
  ...
  enum class ServiceScope(@get:JsonValue val value: String) {
    ...
    companion object {
      @JvmStatic
      @JsonCreator
      fun forValue(value: String): ServiceScope = entries.first { it -> it.value == value }
    }
  }

  @Suppress("ktlint:standard:enum-entry-name-case", "EnumNaming")
  enum class ModelScope(@get:JsonValue val value: String) {
    ...
    companion object {
      @JvmStatic
      @JsonCreator
      fun forValue(value: String): ModelScope = entries.first { it -> it.value == value }
    }
  }
}
