 ...
 */
@jakarta.annotation.Generated(value = ["org.openapitools.codegen.languages.KotlinSpringServerCodegen"], comments = "Generator version: 7.13.0")interface PremisesCas1Delegate {

    fun getRequest(): Optional<NativeWebRequest> = Optional.empty()

    /**
     * @see PremisesCas1#getBed
     */
    fun getBed(premisesId: java.util.UUID,
        bedId: java.util.UUID): ResponseEntity<Cas1BedDetail> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                            ApiUtil.setExampleResponse(request, "application/json", "{  \"characteristics\" : [ \"acceptsChildSexOffenders\", \"acceptsChildSexOffenders\" ],  \"name\" : \"name\",  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"roomName\" : \"roomName\",  \"status\" : \"occupied\"}")
                            break
                        }
                    }
                }
    ...
    fun getBeds(premisesId: java.util.UUID): ResponseEntity<List<Cas1PremisesBedSummary>> {
                    ...
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                            ApiUtil.setExampleResponse(request, "application/json", "[ {  \"characteristics\" : [ \"acceptsChildSexOffenders\", \"acceptsChildSexOffenders\" ],  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"roomName\" : \"roomName\",  \"bedName\" : \"bedName\"}, {  \"characteristics\" : [ \"acceptsChildSexOffenders\", \"acceptsChildSexOffenders\" ],  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"roomName\" : \"roomName\",  \"bedName\" : \"bedName\"} ]")
                            break
                        }
                    }
                }
    ...
    /**
     * @see PremisesCas1#getOccupancyReport
     */
    ...
    fun getPremisesSummaries(gender: Cas1ApprovedPremisesGender?,
        ...
        cruManagementAreaId: java.util.UUID?): ResponseEntity<List<Cas1PremisesBasicSummary>> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    /**
     * @see PremisesCas1#getStaff
     */
    fun getStaff(premisesId: java.util.UUID): ResponseEntity<List<StaffMember>> {
                        getRequest().ifPresent { request ->
                    for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
