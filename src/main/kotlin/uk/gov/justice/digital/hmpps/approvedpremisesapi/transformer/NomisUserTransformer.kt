...
class NomisUserTransformer {
  ...
  fun transformJpaToApi(jpa: Cas2ApplicationEntity): NomisUser = when (jpa.createdByUser) {
    null -> transformJpaToApi(jpa.createdByCas2User!!)
    else -> transformJpaToApi(jpa.createdByUser!!)
  }
