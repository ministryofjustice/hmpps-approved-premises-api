...
data class Adjudication(
  ...
  @get:JsonProperty("establishment", required = true) val establishment: String,
  ...
  @get:JsonProperty("offenceDescription", required = true) val offenceDescription: String,

  @get:JsonProperty("hearingHeld", required = true) val hearingHeld: Boolean,

  @get:JsonProperty("finding") val finding: String? = null,
)
