...
interface ApplicationsApi {
  ...
  fun applicationsApplicationIdAppealsAppealIdGet(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID, @Parameter(description = "ID of the appeal", required = true) @PathVariable("appealId") appealId: java.util.UUID): ResponseEntity<Appeal> = getDelegate().applicationsApplicationIdAppealsAppealIdGet(applicationId, appealId)
  ...
  fun applicationsApplicationIdAppealsPost(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID, @Parameter(description = "the appeal to add", required = true) @RequestBody body: NewAppeal): ResponseEntity<Appeal> = getDelegate().applicationsApplicationIdAppealsPost(applicationId, body)
  ...
  fun applicationsApplicationIdDocumentsGet(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID): ResponseEntity<List<Document>> = getDelegate().applicationsApplicationIdDocumentsGet(applicationId)
  ...
  fun applicationsApplicationIdGet(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID): ResponseEntity<Application> = getDelegate().applicationsApplicationIdGet(applicationId)
  ...
  fun applicationsApplicationIdNotesPost(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID, @Parameter(description = "the note to add", required = true) @RequestBody body: NewApplicationTimelineNote): ResponseEntity<ApplicationTimelineNote> = getDelegate().applicationsApplicationIdNotesPost(applicationId, body)
  ...
  fun applicationsApplicationIdPut(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID, @Parameter(description = "Information to update the application with", required = true) @RequestBody body: UpdateApplication): ResponseEntity<Application> = getDelegate().applicationsApplicationIdPut(applicationId, body)
  ...
  fun applicationsApplicationIdRequestsForPlacementGet(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID): ResponseEntity<List<RequestForPlacement>> = getDelegate().applicationsApplicationIdRequestsForPlacementGet(applicationId)
  ...
  fun applicationsApplicationIdSubmissionPost(@Parameter(description = "Id of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID, @Parameter(description = "Information needed to submit an application", required = true) @RequestBody submitApplication: SubmitApplication): ResponseEntity<Unit> = getDelegate().applicationsApplicationIdSubmissionPost(applicationId, submitApplication)
  ...
  fun applicationsApplicationIdWithdrawablesWithNotesGet(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID, @Parameter(description = "If given, only users for this service will be returned", `in` = ParameterIn.HEADER, required = true, schema = Schema(allowableValues = ["approved-premises", "cas2", "cas2v2", "temporary-accommodation"])) @RequestHeader(value = "X-Service-Name", required = true) xServiceName: ServiceName): ResponseEntity<Withdrawables> = getDelegate().applicationsApplicationIdWithdrawablesWithNotesGet(applicationId, xServiceName)
  ...
  fun applicationsApplicationIdWithdrawalPost(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID, @Parameter(description = "details of the withdrawal", required = true) @RequestBody body: NewWithdrawal): ResponseEntity<Unit> = getDelegate().applicationsApplicationIdWithdrawalPost(applicationId, body)
  ...
  fun applicationsGet(@Parameter(description = "Which service to get applications for, defaults to approved-premises", `in` = ParameterIn.HEADER, schema = Schema(allowableValues = ["approved-premises", "cas2", "cas2v2", "temporary-accommodation"])) @RequestHeader(value = "X-Service-Name", required = false) xServiceName: ServiceName?): ResponseEntity<List<ApplicationSummary>> = getDelegate().applicationsGet(xServiceName)
