...
class ChangeRequestsCas1Controller(
    delegate: uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.ChangeRequestsCas1Delegate?,
) : ChangeRequestsCas1 {
  private lateinit var delegate: uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.ChangeRequestsCas1Delegate
  ...
  override fun getDelegate(): uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.ChangeRequestsCas1Delegate = delegate
}
