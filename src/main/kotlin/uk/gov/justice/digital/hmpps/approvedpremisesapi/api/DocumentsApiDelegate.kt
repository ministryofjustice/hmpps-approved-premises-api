 ...
 */
@jakarta.annotation.Generated(value = ["org.openapitools.codegen.languages.KotlinSpringServerCodegen"], comments = "Generator version: 7.13.0")interface DocumentsApiDelegate {
     ...
     */
    fun documentsCrnDocumentIdGet(crn: kotlin.String,
        documentId: java.util.UUID): ResponseEntity<org.springframework.web.servlet.mvc.method.annotation.StreamingResponseBody> {
