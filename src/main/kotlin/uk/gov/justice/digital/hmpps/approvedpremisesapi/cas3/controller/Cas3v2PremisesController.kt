...
class Cas3v2PremisesController(
  ...
  fun createPremises(@RequestBody body: Cas3NewPremises): ResponseEntity<Cas3Premises> {
    ...
    // not ideal, but this field has been renamed for consistency with the returning Cas3Premises model (the v1 and v2 characteristic entities have different fields).
    if (body.characteristicIds != null) throw BadRequestProblem(errorDetail = "$.characteristics field must be null for /v2/. Use premisesCharacteristics")
