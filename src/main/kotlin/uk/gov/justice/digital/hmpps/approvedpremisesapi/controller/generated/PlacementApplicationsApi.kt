...
interface PlacementApplicationsApi {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = PlacementApplication::class))],
      ),
      ApiResponse(
        responseCode = "400",
  ...
  fun placementApplicationsIdGet(
    @Parameter(
      description = "Id of the application",
      required = true,
    ) @PathVariable("id") id: java.util.UUID,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(array = ArraySchema(schema = Schema(implementation = PlacementApplication::class)))],
      ),
      ApiResponse(
        responseCode = "400",
  ...
  fun placementApplicationsIdWithdrawPost(
    ...
    @Parameter(description = "Withdrawal details") @RequestBody(required = false) withdrawPlacementApplication: WithdrawPlacementApplication?,
  ): ResponseEntity<PlacementApplication> {
