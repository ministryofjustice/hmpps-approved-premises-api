  ...
  private fun sendEmailToReferrer(
    ...
    if (application.createdByCas2User!!.email != null) {
      ...
      emailNotificationService.sendCas2Email(
        recipientEmailAddress = application.createdByCas2User!!.email!!,
      ...
      log.error("Email not found for User ${application.createdByCas2User!!.id}. Unable to send email for Note ${savedNote.id} on Application ${application.id}")
      Sentry.captureMessage("Email not found for User ${application.createdByCas2User!!.id}. Unable to send email for Note ${savedNote.id} on Application ${application.id}")
    }
  }
