...
interface UsersApi {
  ...
  fun usersDeliusGet(
    @Parameter(description = "Name of the user", required = true) @RequestParam(
      value = "name",
      required = true,
    ) name: kotlin.String,
    @Parameter(
  ...
  fun usersGet(
    ...
    @Parameter(description = "Only return users with the provided role(s)") @RequestParam(
      value = "roles",
      required = false,
    ) roles: kotlin.collections.List<ApprovedPremisesUserRole>?,
    @Parameter(description = "Only return users with the provided qualification(s)") @RequestParam(
      value = "qualifications",
      required = false,
    ) qualifications: kotlin.collections.List<UserQualification>?,
    @Parameter(description = "Probation region ID to filter results by") @RequestParam(
    ...
    ) @RequestParam(value = "sortBy", required = false) sortBy: UserSortField?,
    @Parameter(
  ...
  fun usersIdPut(
    ...
    @Parameter(
      description = "",
      required = true,
    ) @RequestBody userRolesAndQualifications: UserRolesAndQualifications,
  ): ResponseEntity<User> {
  ...
  fun usersSummaryGet(
    ...
    return getDelegate().usersSummaryGet(
      xServiceName,
      roles,
      qualifications,
      probationRegionId,
