...
enum class DomainEventType(
  ...
  APPROVED_PREMISES_APPLICATION_SUBMITTED(
    ...
    TimelineEventType.APPROVED_PREMISES_APPLICATION_SUBMITTED,
  ),
  ...
  APPROVED_PREMISES_PERSON_ARRIVED(
    ...
    TimelineEventType.APPROVED_PREMISES_PERSON_ARRIVED,
  ),
  APPROVED_PREMISES_PERSON_NOT_ARRIVED(
    ...
    TimelineEventType.APPROVED_PREMISES_PERSON_NOT_ARRIVED,
  ),
  APPROVED_PREMISES_PERSON_DEPARTED(
    DomainEventCas.CAS1,
    Cas1EventType.personDeparted.value,
    "Someone has left an Approved Premises",
    TimelineEventType.APPROVED_PREMISES_PERSON_DEPARTED,
  ),
  ...
  APPROVED_PREMISES_BOOKING_CHANGED(
    ...
    TimelineEventType.APPROVED_PREMISES_BOOKING_CHANGED,
  ),
  APPROVED_PREMISES_BOOKING_KEYWORKER_ASSIGNED(
    ...
    TimelineEventType.APPROVED_PREMISES_BOOKING_KEYWORKER_ASSIGNED,
  ),
  APPROVED_PREMISES_APPLICATION_WITHDRAWN(
    ...
    TimelineEventType.APPROVED_PREMISES_APPLICATION_WITHDRAWN,
  ),
  APPROVED_PREMISES_ASSESSMENT_APPEALED(
    ...
    TimelineEventType.APPROVED_PREMISES_ASSESSMENT_APPEALED,
  ),
  APPROVED_PREMISES_ASSESSMENT_ALLOCATED(
    ...
    TimelineEventType.APPROVED_PREMISES_ASSESSMENT_ALLOCATED,
  ),
  APPROVED_PREMISES_ASSESSMENT_INFO_REQUESTED(
    ...
    TimelineEventType.APPROVED_PREMISES_INFORMATION_REQUEST,
  ),
  APPROVED_PREMISES_PLACEMENT_APPLICATION_WITHDRAWN(
    ...
    TimelineEventType.APPROVED_PREMISES_PLACEMENT_APPLICATION_WITHDRAWN,
  ),
  APPROVED_PREMISES_PLACEMENT_APPLICATION_ALLOCATED(
    ...
    TimelineEventType.APPROVED_PREMISES_PLACEMENT_APPLICATION_ALLOCATED,
  ),
  APPROVED_PREMISES_MATCH_REQUEST_WITHDRAWN(
    ...
    TimelineEventType.APPROVED_PREMISES_MATCH_REQUEST_WITHDRAWN,
  ),
  APPROVED_PREMISES_REQUEST_FOR_PLACEMENT_CREATED(
    ...
    TimelineEventType.APPROVED_PREMISES_REQUEST_FOR_PLACEMENT_CREATED,
  ),
  APPROVED_PREMISES_REQUEST_FOR_PLACEMENT_ASSESSED(
    ...
    TimelineEventType.APPROVED_PREMISES_REQUEST_FOR_PLACEMENT_ASSESSED,
  ),
