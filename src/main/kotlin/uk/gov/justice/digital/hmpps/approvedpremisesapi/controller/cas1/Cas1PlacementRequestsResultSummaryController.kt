...
@Service
class Cas1PlacementRequestsResultSummaryController(
  ...
  private fun mapPersonDetailOntoPlacementRequests(
    ...
    return placementRequests.map {
      cas1PlacementRequestSummaryTransformer.transformCas1PlacementRequestSummaryJpaToApi(
        it,
        offenderService.getPersonInfoResult(it.getPersonCrn(), user.cas1LimitedAccessStrategy()) is PersonInfoResult.Success.Full,
      )
    }
  }
}
