...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.service.cas2bail.Cas2ReportsService

@Service("Cas2BailReportsController")
class Cas2BailReportsController(private val cas2BailReportService: Cas2ReportsService) : ReportsCas2bailDelegate {
