...
enum class UserPermission(val cas1ApiValue: ApprovedPremisesUserPermission?, val experimental: Boolean = false) {
  ...
  CAS1_SPACE_BOOKING_CREATE_ADDITIONAL(ApprovedPremisesUserPermission.cas1SpaceBookingCreateAdditional),
  CAS1_AP_RESIDENT_PROFILE(ApprovedPremisesUserPermission.apResidentProfile, experimental = true),
  ;
