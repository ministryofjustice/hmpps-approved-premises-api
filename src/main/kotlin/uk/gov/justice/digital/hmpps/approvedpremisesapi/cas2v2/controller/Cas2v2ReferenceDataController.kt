...
class Cas2v2ReferenceDataController(
  ...
  private fun transformToApi(statusList: List<Cas2HdcPersistedApplicationStatus>): List<Cas2v2ApplicationStatus> = statusList.map { status -> statusTransformer.transformV2ModelToApi(status) }
}
