...
class Cas2v2ApplicationNoteService(
  ...
  private val assessmentUrlTemplate: String,
) {

  private val log = LoggerFactory.getLogger(this::class.java)

  @Suppress("ReturnCount")
  fun createAssessmentNote(
    assessmentId: UUID,
    note: NewCas2ApplicationNote,
  ): CasResult<Cas2v2ApplicationNoteEntity> {
    val assessment =
      cas2v2AssessmentRepository.findByIdOrNull(assessmentId) ?: return CasResult.NotFound()

    val application =
      cas2v2ApplicationRepository.findByIdOrNull(assessment.application.id)
