...
interface CharacteristicRepository : JpaRepository<CharacteristicEntity, UUID> {
  ...
  fun findBedspaceCharacteristicsMappingsByBedIds(bedIds: List<UUID>): List<Cas3BedspaceCharacteristicAssignmentId>
  ...
  fun findPremisesCharacteristicsMappingsByPremiseIds(premisesIds: List<UUID>): List<Cas3PremisesCharacteristicAssignmentId>
  ...
  fun findAllByServiceAndModelScope(modelScope: String, serviceScope: String): List<CharacteristicEntity>
}
