...
interface AssessmentsCas2Delegate {
    ...
    fun assessmentsAssessmentIdNotesPost(assessmentId: java.util.UUID,
        ...
        getRequest().ifPresent { request ->
            for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    uk.gov.justice.digital.hmpps.approvedpremisesapi.controller.generated.cas2.ApiUtil.setExampleResponse(request, "application/json", "{  \"createdAt\" : \"2000-01-23T04:56:07.000+00:00\",  \"name\" : \"Roger Smith\",  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"body\" : \"body\",  \"email\" : \"roger@example.com\"}")
                    break
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    uk.gov.justice.digital.hmpps.approvedpremisesapi.controller.generated.cas2.ApiUtil.setExampleResponse(request, "application/json", "{  \"instance\" : \"f7493e12-546d-42c3-b838-06c12671ab5b\",  \"detail\" : \"You provided invalid request parameters\",  \"type\" : \"https://example.net/validation-error\",  \"title\" : \"Invalid request parameters\",  \"status\" : 400}")
