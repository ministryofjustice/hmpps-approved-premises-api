  ...
  fun securityFilterChain(http: HttpSecurity, @Autowired jsonMapper: JsonMapper): SecurityFilterChain {
    http {
      ...
      authorizeHttpRequests {
        ...
        authorize(HttpMethod.POST, "/cas2-hdc/assessments/*/notes", hasAnyAuthority("ROLE_LICENCE_CA", Cas2Role.POM, Cas2Role.ASSESSOR, Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER))
        ...
        authorize("/cas2-hdc/**", hasAnyAuthority(Cas2Role.POM, "ROLE_LICENCE_CA", Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER))
