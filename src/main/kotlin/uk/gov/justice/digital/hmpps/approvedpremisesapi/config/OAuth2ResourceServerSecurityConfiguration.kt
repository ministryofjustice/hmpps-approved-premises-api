  ...
  fun securityFilterChain(http: HttpSecurity, @Autowired jsonMapper: JsonMapper): SecurityFilterChain {
    http {
      ...
      authorizeHttpRequests {
        ...
        authorize(HttpMethod.POST, "/cas2/assessments/*/notes", hasAnyRole("LICENCE_CA", "POM", "CAS2_ASSESSOR", "CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER"))
        ...
        authorize(HttpMethod.POST, "/cas2v2/assessments/*/notes", hasAnyAuthority("ROLE_CAS2_ASSESSOR", "ROLE_CAS2_COURT_BAIL_REFERRER", "ROLE_CAS2_PRISON_BAIL_REFERRER"))
        authorize(HttpMethod.GET, "/cas2v2/submissions/**", hasAnyAuthority("ROLE_CAS2_ASSESSOR", "ROLE_CAS2_ADMIN"))
        ...
        authorize(HttpMethod.GET, "/subject-access-request/**", hasRole("SAR_DATA_ACCESS"))
