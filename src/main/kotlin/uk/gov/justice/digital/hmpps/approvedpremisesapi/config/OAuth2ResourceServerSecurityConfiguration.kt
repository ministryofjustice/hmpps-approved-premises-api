  ...
  fun securityFilterChain(http: HttpSecurity, @Autowired objectMapper: ObjectMapper): SecurityFilterChain {
    http {
      ...
      authorizeHttpRequests {
        ...
        authorize(HttpMethod.GET, "/cas2v2/assessments/**", hasAnyRole("CAS2_ASSESSOR", "CAS2_ADMIN", "CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER", "CAS2_COURT_BAIL", "CAS2_PRISON_BAIL"))
        authorize(HttpMethod.POST, "/cas2v2/assessments/*/status-updates", hasAnyRole("CAS2_ASSESSOR"))
        authorize(HttpMethod.POST, "/cas2v2/assessments/*/notes", hasAnyRole("CAS2_ASSESSOR", "CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER", "CAS2_COURT_BAIL", "CAS2_PRISON_BAIL"))
        authorize(HttpMethod.GET, "/cas2v2/submissions/**", hasAnyRole("CAS2_ASSESSOR", "CAS2_ADMIN", "CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER", "CAS2_COURT_BAIL", "CAS2_PRISON_BAIL"))
        authorize(HttpMethod.POST, "/cas2v2/submissions", hasAnyRole("CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER", "CAS2_COURT_BAIL", "CAS2_PRISON_BAIL"))
