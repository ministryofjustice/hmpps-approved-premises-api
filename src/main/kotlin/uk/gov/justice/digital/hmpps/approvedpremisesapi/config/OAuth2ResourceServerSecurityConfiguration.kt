...
class OAuth2ResourceServerSecurityConfiguration {
  ...
  fun securityFilterChain(http: HttpSecurity, @Autowired jsonMapper: JsonMapper): SecurityFilterChain {
    http {
      csrf { disable() }
      ...
      authorizeHttpRequests {
        ...
        authorize(HttpMethod.GET, "/events/cas2/**", hasAuthority(Cas2Role.CAS2_EVENTS))
        ...
        authorize(HttpMethod.PUT, "/cas2-hdc/assessments/**", hasAuthority(Cas2Role.ASSESSOR))
        authorize(HttpMethod.GET, "/cas2-hdc/assessments/**", hasAnyAuthority(Cas2Role.ASSESSOR, Cas2Role.ADMIN, Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER))
        authorize(HttpMethod.POST, "/cas2-hdc/assessments/*/status-updates", hasAuthority(Cas2Role.ASSESSOR))
        authorize(HttpMethod.POST, "/cas2-hdc/assessments/*/notes", hasAnyAuthority(Cas2Role.LICENCE_CA, Cas2Role.POM, Cas2Role.ASSESSOR, Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER))
        authorize(HttpMethod.GET, "/cas2-hdc/submissions/**", hasAnyAuthority(Cas2Role.ASSESSOR, Cas2Role.ADMIN))
        authorize(HttpMethod.POST, "/cas2-hdc/submissions/*/status-updates", hasAuthority(Cas2Role.ASSESSOR))
        authorize(HttpMethod.GET, "/cas2-hdc/reference-data/**", hasAnyAuthority(Cas2Role.ASSESSOR, Cas2Role.POM, Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER))
        authorize(HttpMethod.GET, "/cas2-hdc/reports/**", hasAuthority(Cas2Role.MI))
        authorize("/cas2-hdc/**", hasAnyAuthority(Cas2Role.POM, Cas2Role.LICENCE_CA, Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER))

        authorize(HttpMethod.PUT, "/cas2/assessments/**", hasAuthority(Cas2Role.ASSESSOR))
        authorize(HttpMethod.GET, "/cas2/assessments/**", hasAnyAuthority(Cas2Role.ASSESSOR, Cas2Role.ADMIN, Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER, Cas2Role.PROBATION))
        authorize(HttpMethod.POST, "/cas2/assessments/*/status-updates", hasAuthority(Cas2Role.ASSESSOR))
        authorize(HttpMethod.POST, "/cas2/assessments/*/notes", hasAnyAuthority(Cas2Role.ASSESSOR, Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER, Cas2Role.PROBATION))
        authorize(HttpMethod.GET, "/cas2/submissions/**", hasAnyAuthority(Cas2Role.ASSESSOR, Cas2Role.ADMIN))
        authorize(HttpMethod.POST, "/cas2/submissions/*/status-updates", hasAuthority(Cas2Role.ASSESSOR))
        authorize(HttpMethod.GET, "/cas2/reference-data/**", hasAnyAuthority(Cas2Role.ASSESSOR, Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER, Cas2Role.PROBATION))
        authorize(HttpMethod.GET, "/cas2/reports/**", hasAuthority(Cas2Role.MI))
        authorize(HttpMethod.GET, "/cas2/people/*/oasys/**", hasAnyAuthority(Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER, Cas2Role.PROBATION))
        ...
        authorize(HttpMethod.GET, "/subject-access-request", hasAuthority("ROLE_SAR_DATA_ACCESS"))
        authorize(HttpMethod.GET, "/subject-access-request/template", hasAuthority("ROLE_SAR_DATA_ACCESS"))
        ...
        authorize(anyRequest, hasAuthority(Cas2Role.PROBATION))
      }
...
class LoggingInMemoryOAuth2AuthorizedClientService(clientRegistrationRepository: ClientRegistrationRepository, private val jsonMapper: JsonMapper) : OAuth2AuthorizedClientService {
