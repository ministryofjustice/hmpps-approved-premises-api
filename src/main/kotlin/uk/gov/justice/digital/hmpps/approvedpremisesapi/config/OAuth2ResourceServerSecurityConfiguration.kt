  ...
  fun securityFilterChain(http: HttpSecurity, @Autowired objectMapper: ObjectMapper): SecurityFilterChain {
    http {
      ...
      authorizeHttpRequests {
        ...
        authorize(HttpMethod.PUT, "/cas2v2/assessments/**", hasAnyRole("CAS2_ASSESSOR"))
        authorize(HttpMethod.GET, "/cas2v2/assessments/**", hasAnyRole("CAS2_ASSESSOR", "CAS2_ADMIN", "CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER"))
        authorize(HttpMethod.POST, "/cas2v2/assessments/*/status-updates", hasAnyRole("CAS2_ASSESSOR"))
        authorize(HttpMethod.POST, "/cas2v2/assessments/*/notes", hasAnyRole("CAS2_ASSESSOR", "CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER"))
        authorize(HttpMethod.GET, "/cas2v2/submissions/**", hasAnyRole("CAS2_ASSESSOR", "CAS2_ADMIN", "CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER"))
        authorize(HttpMethod.POST, "/cas2v2/submissions", hasAnyRole("CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER"))
        authorize(HttpMethod.GET, "/cas2v2/reference-data/**", hasAnyRole("CAS2_ASSESSOR"))
        authorize(HttpMethod.GET, "/cas2v2/reports/**", hasAnyRole("CAS2_MI"))
        authorize(HttpMethod.GET, "/cas2v2/people/search-by-crn/**", hasAnyRole("CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER"))
        authorize(HttpMethod.GET, "/cas2v2/people/search-by-noms/**", hasAnyRole("CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER"))
        authorize(HttpMethod.GET, "/cas2v2/**", hasAnyRole("CAS2_COURT_BAIL_REFERRER", "CAS2_PRISON_BAIL_REFERRER"))
