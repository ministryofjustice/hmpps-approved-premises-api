  ...
  fun securityFilterChain(http: HttpSecurity, @Autowired jsonMapper: JsonMapper): SecurityFilterChain {
    http {
      ...
      authorizeHttpRequests {
        ...
        authorize(HttpMethod.GET, "/cas2/assessments/**", hasAnyAuthority("ROLE_CAS2_ASSESSOR", "ROLE_CAS2_ADMIN", "ROLE_CAS2_COURT_BAIL_REFERRER", "ROLE_CAS2_PRISON_BAIL_REFERRER", "ROLE_PROBATION"))
        authorize(HttpMethod.POST, "/cas2/assessments/*/status-updates", hasAuthority("ROLE_CAS2_ASSESSOR"))
        authorize(HttpMethod.POST, "/cas2/assessments/*/notes", hasAnyAuthority("ROLE_CAS2_ASSESSOR", "ROLE_CAS2_COURT_BAIL_REFERRER", "ROLE_CAS2_PRISON_BAIL_REFERRER", "ROLE_PROBATION"))
        ...
        authorize(HttpMethod.GET, "/cas2/reference-data/**", hasAnyAuthority("ROLE_CAS2_ASSESSOR", "ROLE_CAS2_COURT_BAIL_REFERRER", "ROLE_CAS2_PRISON_BAIL_REFERRER", "ROLE_PROBATION"))
        ...
        authorize(HttpMethod.GET, "/cas2/people/search-by-crn/**", hasAnyAuthority("ROLE_CAS2_COURT_BAIL_REFERRER", "ROLE_CAS2_PRISON_BAIL_REFERRER", "ROLE_PROBATION"))
        authorize(HttpMethod.GET, "/cas2/people/search-by-noms/**", hasAnyAuthority("ROLE_CAS2_COURT_BAIL_REFERRER", "ROLE_CAS2_PRISON_BAIL_REFERRER", "ROLE_PROBATION"))
        authorize(HttpMethod.GET, "/cas2/external/**", hasAuthority("ROLE_APPROVED_PREMISES__SINGLE_ACCOMMODATION_SERVICE"))
        authorize("/cas2/applications/**", hasAnyAuthority("ROLE_CAS2_COURT_BAIL_REFERRER", "ROLE_CAS2_PRISON_BAIL_REFERRER", "ROLE_PROBATION"))
