  ...
  fun securityFilterChain(http: HttpSecurity, @Autowired jsonMapper: JsonMapper): SecurityFilterChain {
    http {
      ...
      authorizeHttpRequests {
        ...
        authorize(HttpMethod.GET, "/cas2-hdc/assessments/**", hasAnyAuthority(Cas2Role.ASSESSOR, "ROLE_CAS2_ADMIN", Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER))
        ...
        authorize(HttpMethod.GET, "/cas2-hdc/submissions/**", hasAnyAuthority(Cas2Role.ASSESSOR, "ROLE_CAS2_ADMIN"))
        ...
        authorize(HttpMethod.GET, "/cas2/assessments/**", hasAnyAuthority(Cas2Role.ASSESSOR, "ROLE_CAS2_ADMIN", Cas2Role.COURT_BAIL_REFERRER, Cas2Role.PRISON_BAIL_REFERRER, Cas2Role.PROBATION))
        ...
        authorize(HttpMethod.GET, "/cas2/submissions/**", hasAnyAuthority(Cas2Role.ASSESSOR, "ROLE_CAS2_ADMIN"))
