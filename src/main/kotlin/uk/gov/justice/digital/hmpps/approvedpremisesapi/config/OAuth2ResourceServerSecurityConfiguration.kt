  ...
  fun securityFilterChain(http: HttpSecurity, @Autowired objectMapper: ObjectMapper): SecurityFilterChain {
    http {
      ...
      authorizeHttpRequests {
        ...
        authorize(HttpMethod.GET, "/cas2v2/applications/**", hasAnyRole("POM", "LICENCE_CA", "PROBATION"))
        ...
        authorize(HttpMethod.GET, "/cas2v2/people/search-by-crn/**", hasRole("PROBATION"))
        authorize(HttpMethod.GET, "/cas2v2/people/search-by-noms/**", hasAnyRole("POM", "LICENCE_CA", "PROBATION"))
        authorize("/cas2v2/**", hasAnyRole("POM", "LICENCE_CA"))
