...
interface PeopleCas2v2 {
    ...
    fun searchByCrnGet(@Parameter(description = "CRN to search for", required = true) @PathVariable("crn") crn: kotlin.String): ResponseEntity<Person> {
    ...
    fun searchByNomisIdGet(@Parameter(description = "Prison Number to search for", required = true) @PathVariable("nomsNumber") nomsNumber: kotlin.String): ResponseEntity<Person> {
