...
class Cas1RequestForPlacementService(
  ...
  fun defaultDurations(
    ...
    val responseDto = when (requestDto.apType) {
      ApType.pipe -> Cas1RequestsForPlacementDurationsCalculationResponseDto(26 * 7, null)
      ApType.esap -> Cas1RequestsForPlacementDurationsCalculationResponseDto(52 * 7, null)
      ApType.normal,
      ApType.rfap,
      ApType.mhapStJosephs,
      ApType.mhapElliottHouse,
      -> Cas1RequestsForPlacementDurationsCalculationResponseDto(12 * 7, null)
    }
