...
class Cas2HdcReferenceDataController(
  ...
  private fun transformToApi(statusList: List<Cas2HdcPersistedApplicationStatus>): List<Cas2HdcApplicationStatus> = statusList.map { status -> statusTransformer.transformModelToApi(status) }
}
