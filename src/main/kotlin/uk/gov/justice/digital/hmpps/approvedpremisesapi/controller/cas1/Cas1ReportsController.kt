...
class Cas1ReportsController(
  ...
  override fun getReportByName(
    ...
    return when (reportName) {
      Cas1ReportName.applicationsV2 -> generateStreamingResponse(
        ...
        fileName = createCas1ReportName("applications", startDate, endDate),
      ) { outputStream ->
      ...
      Cas1ReportName.applicationsV2WithPii -> generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("applications-with-pii", startDate, endDate),
      ) { outputStream ->
      ...
      Cas1ReportName.dailyMetrics -> generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("daily-metrics", startDate, endDate),
      ) { outputStream ->
      ...
      Cas1ReportName.outOfServiceBeds -> return generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("out-of-service-beds", startDate, endDate),
      ) { outputStream ->
      ...
      Cas1ReportName.outOfServiceBedsWithPii -> return generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("out-of-service-beds-with-pii", startDate, endDate),
      ) { outputStream ->
        userAccessService.ensureCurrentUserHasPermission(UserPermission.CAS1_REPORTS_VIEW_WITH_PII)
      ...
      Cas1ReportName.requestsForPlacement -> generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("requests-for-placement", startDate, endDate),
      ) { outputStream ->
      ...
      Cas1ReportName.requestsForPlacementWithPii -> generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("requests-for-placement-with-pii", startDate, endDate),
      ) { outputStream ->
        userAccessService.ensureCurrentUserHasPermission(UserPermission.CAS1_REPORTS_VIEW_WITH_PII)
      ...
      Cas1ReportName.placementMatchingOutcomesV2 -> generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("placement-matching-outcomes", startDate, endDate),
      ) { outputStream ->
      ...
      Cas1ReportName.placementMatchingOutcomesV2WithPii -> generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("placement-matching-outcomes-with-pii", startDate, endDate),
      ) { outputStream ->
        userAccessService.ensureCurrentUserHasPermission(UserPermission.CAS1_REPORTS_VIEW_WITH_PII)
      ...
      Cas1ReportName.placements -> generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("placements", startDate, endDate),
      ) { outputStream ->
      ...
      Cas1ReportName.placementsWithPii -> generateStreamingResponse(
        contentType = ContentType.CSV,
        fileName = createCas1ReportName("placements-with-pii", startDate, endDate),
      ) { outputStream ->
        userAccessService.ensureCurrentUserHasPermission(UserPermission.CAS1_REPORTS_VIEW_WITH_PII)
  ...
  private fun createCas1ReportName(
    ...
    return "$name-$startFormatted-to-$endFormatted-$timestamp.${ContentType.CSV.extension}"
  }
