    ...
    getRequest().ifPresent { request ->
      for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
            uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.ApiUtil.setExampleResponse(
                request,
                "application/json",
      ...
      for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
            uk.gov.justice.digital.hmpps.approvedpremisesapi.api.cas1.cas1.ApiUtil.setExampleResponse(
                request,
                "application/json",
                "[ {  \"name\" : \"Double Room with Single Occupancy - Other (Non-FM)\",  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"isActive\" : true}, {  \"name\" : \"Double Room with Single Occupancy - Other (Non-FM)\",  \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",  \"isActive\" : true} ]",
            )
          break
        }
        if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
