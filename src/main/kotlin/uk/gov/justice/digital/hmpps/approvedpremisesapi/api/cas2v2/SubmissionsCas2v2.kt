  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = Cas2v2SubmittedApplication::class))],
      ),
      ApiResponse(
        responseCode = "401",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = Cas2v2SubmittedApplicationSummary::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
