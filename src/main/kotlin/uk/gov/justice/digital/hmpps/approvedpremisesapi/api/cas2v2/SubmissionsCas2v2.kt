...
@RestController
interface SubmissionsCas2v2 {

    fun getDelegate(): SubmissionsCas2v2Delegate = object: SubmissionsCas2v2Delegate {}
    ...
    @Operation(
        ...
        description = """""",
        responses = [
            ApiResponse(responseCode = "200", description = "successful operation", content = [Content(schema = Schema(implementation = Cas2v2SubmittedApplication::class))]),
    ...
    fun submissionsApplicationIdGet(@Parameter(description = "ID of the application", required = true) @PathVariable("applicationId") applicationId: java.util.UUID): ResponseEntity<Cas2v2SubmittedApplication> {
    ...
    @Operation(
        ...
        description = """""",
        responses = [
            ApiResponse(responseCode = "200", description = "successful operation", content = [Content(array = ArraySchema(schema = Schema(implementation = Cas2v2SubmittedApplicationSummary::class)))]),
            ApiResponse(responseCode = "401", description = "not authenticated", content = [Content(schema = Schema(implementation = Problem::class))]),
            ApiResponse(responseCode = "403", description = "unauthorised", content = [Content(schema = Schema(implementation = Problem::class))]),
            ApiResponse(responseCode = "500", description = "unexpected error", content = [Content(schema = Schema(implementation = Problem::class))])
        ]
    ...
    fun submissionsGet(@Parameter(description = "Page number of results to return. If blank, returns all results") @RequestParam(value = "page", required = false) page: kotlin.Int?): ResponseEntity<List<Cas2v2SubmittedApplicationSummary>> {
    ...
    fun submissionsPost(@Parameter(description = "Information needed to submit an application", required = true) @RequestBody submitCas2v2Application: SubmitCas2v2Application): ResponseEntity<Unit> {
        return getDelegate().submissionsPost(submitCas2v2Application)
    }
}
