...
interface PremisesApi {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(array = ArraySchema(schema = Schema(implementation = Premises::class)))],
      ),
      ApiResponse(
        responseCode = "401",
  ...
  fun premisesGet(
    ...
    @Parameter(
      ...
      `in` = ParameterIn.HEADER,
    ) @RequestHeader(value = "X-User-Region", required = false) xUserRegion: java.util.UUID?,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        ...
        content = [Content(schema = Schema(implementation = Premises::class))],
      ),
      ApiResponse(
        responseCode = "400",
  ...
  fun premisesPost(
    @Parameter(description = "", required = true) @RequestBody body: NewPremises,
    @Parameter(
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = BedDetail::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun premisesPremisesIdBedsBedIdGet(
    ...
    @Parameter(
      ...
      required = true,
    ) @PathVariable("bedId") bedId: java.util.UUID,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = BedSummary::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun premisesPremisesIdBedsGet(
    @Parameter(
      description = "ID of the premises to list the beds for",
      required = true,
    ) @PathVariable("premisesId") premisesId: java.util.UUID,
  ): ResponseEntity<List<BedSummary>> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = Arrival::class))],
      ),
      ApiResponse(
        responseCode = "400",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = Cancellation::class))],
      ),
      ApiResponse(
        responseCode = "400",
        description = "invalid params",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = Confirmation::class))],
      ),
      ApiResponse(
        responseCode = "400",
        description = "invalid params",
  ...
  fun premisesPremisesIdBookingsBookingIdConfirmationsPost(
    ...
    @Parameter(
      ...
      required = true,
    ) @RequestBody body: NewConfirmation,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = DateChange::class))],
      ),
      ApiResponse(
        responseCode = "400",
        description = "invalid params",
  ...
  fun premisesPremisesIdBookingsBookingIdDateChangesPost(
    ...
    @Parameter(
      ...
      required = true,
    ) @RequestBody body: NewDateChange,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = Departure::class))],
      ),
      ApiResponse(
        responseCode = "400",
        description = "invalid params",
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = Turnaround::class))],
      ),
      ApiResponse(
        responseCode = "400",
        description = "invalid params",
  ...
  fun premisesPremisesIdBookingsBookingIdTurnaroundsPost(
    ...
    @Parameter(
      ...
      required = true,
    ) @RequestBody body: NewTurnaround,
  ...
  fun premisesPremisesIdBookingsGet(
    @Parameter(
  ...
  fun premisesPremisesIdBookingsPost(
    ...
    @Parameter(description = "", required = true) @RequestBody body: NewBooking,
  ): ResponseEntity<Booking> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = LostBed::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun premisesPremisesIdLostBedsGet(
    @Parameter(
      description = "ID of the premises to show lost beds for",
      required = true,
    ) @PathVariable("premisesId") premisesId: java.util.UUID,
  ): ResponseEntity<List<LostBed>> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = LostBedCancellation::class))],
      ),
      ApiResponse(
        responseCode = "400",
        description = "invalid params",
  ...
  fun premisesPremisesIdLostBedsLostBedIdCancellationsPost(
    ...
    @Parameter(
      ...
      required = true,
    ) @PathVariable("lostBedId") lostBedId: java.util.UUID,
    @Parameter(
      description = "details of the cancellation",
      required = true,
    ) @RequestBody body: NewLostBedCancellation,
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = LostBed::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun premisesPremisesIdLostBedsLostBedIdPut(
    ...
    @Parameter(
      ...
      required = true,
    ) @RequestBody body: UpdateLostBed,
  ): ResponseEntity<LostBed> {
  ...
  fun premisesPremisesIdPut(
    ...
    @Parameter(
      ...
      required = true,
    ) @RequestBody body: UpdatePremises,
  ): ResponseEntity<Premises> {
  ...
  fun premisesPremisesIdRoomsGet(
    @Parameter(
  ...
  fun premisesPremisesIdRoomsRoomIdGet(
    ...
    @Parameter(
      ...
      required = true,
    ) @PathVariable("roomId") roomId: java.util.UUID,
  ): ResponseEntity<Room> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = StaffMember::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun premisesPremisesIdStaffGet(
    @Parameter(
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(schema = Schema(implementation = ExtendedPremisesSummary::class))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun premisesPremisesIdSummaryGet(
    @Parameter(
      description = "ID of the premises to get bookings for",
      required = true,
    ) @PathVariable("premisesId") premisesId: java.util.UUID,
  ): ResponseEntity<ExtendedPremisesSummary> {
  ...
  @Operation(
    ...
    responses = [
      ApiResponse(
        responseCode = "200",
        description = "successful operation",
        content = [Content(array = ArraySchema(schema = Schema(implementation = PremisesSummary::class)))],
      ),
      ApiResponse(
        responseCode = "401",
        description = "not authenticated",
  ...
  fun premisesSummaryGet(
    ...
    @Parameter(description = "ID of the probation region to filter by") @RequestParam(
      value = "probationRegionId",
      required = false,
    ) probationRegionId: java.util.UUID?,
    @Parameter(description = "ID of the AP area to filter by") @RequestParam(
      value = "apAreaId",
      required = false,
