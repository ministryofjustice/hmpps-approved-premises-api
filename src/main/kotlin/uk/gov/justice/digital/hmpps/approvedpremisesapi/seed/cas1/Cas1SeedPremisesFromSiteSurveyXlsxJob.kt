...
class Cas1SeedPremisesFromSiteSurveyXlsxJob(
  ...
  private fun resolvePremiseInfo(siteSurveyPremise: Cas1SiteSurveyPremise): PremisesInfo {
    val localAuthorityAreaName = siteSurveyPremise.localAuthorityArea
    ...
    return PremisesInfo(
      ...
      localAuthorityArea = localAuthorityAreaRepository.findByName(siteSurveyPremise.localAuthorityArea)
  ...
  private fun resolveCharacteristics(siteSurveyPremise: Cas1SiteSurveyPremise): List<CharacteristicEntity> {
    return listOf(
      ...
      CharacteristicRequired("isCatered", siteSurveyPremise.cateredOrSelfCatered == Catering.CATERED),
