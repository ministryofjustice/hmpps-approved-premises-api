...
class ApplicationsController(
  ...
  private fun getPeopleDetailsAndTransformToSummaries(applications: List<Cas2ApplicationSummary>, user: NomisUserEntity): List<ApplicationSummary> {
    ...
    for (application in applications) {
      ...
      val offenderDetailSummary = peopleInfo[crn] ?: throw NotFoundProblem(crn, "No offender details found")

      val personInfo = offenderService.getInfoForOffender(application.getCrn(), offenderDetailSummary)
