...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.api.events.cas2v2.model.Cas2v2Event
...
class Cas2v2DomainEventService(
  ...
  fun getCas2ApplicationSubmittedDomainEvent(id: UUID) = get<Cas2v2ApplicationSubmittedEvent>(id)
  ...
  private fun <T : Cas2v2Event> saveAndEmit(
