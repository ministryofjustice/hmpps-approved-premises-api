...
class Cas1ChangeRequestService(
  ...
  fun createChangeRequest(placementRequestId: UUID, cas1NewChangeRequest: Cas1NewChangeRequest): CasResult<Unit> = validatedCasResult {
    ...
    if (!listOf(Cas1ChangeRequestType.PLANNED_TRANSFER, Cas1ChangeRequestType.APPEAL).contains(cas1NewChangeRequest.type)) {
      return CasResult.GeneralValidationError("Change request type is not ${Cas1ChangeRequestType.PLANNED_TRANSFER} or ${Cas1ChangeRequestType.APPEAL}")
    }
...
//  private fun tryGetPlacementRequest(placementRequestId: UUID): Any {
//    return placementRequestRepository.findByIdOrNull(placementRequestId)
//      ?: return CasResult.NotFound("Placement Request", placementRequestId.toString())
//  }

//  private fun tryGetChangeRequestReason(changeRequestReasonId: UUID): Cas1ChangeRequestReasonEntity = cas1ChangeRequestReasonRepository.findByIdOrNull(changeRequestReasonId)
//    ?: throw NotFoundProblem(changeRequestReasonId, "Change Request Reason")
//
//  private fun tryGetSpaceBooking(spaceBookingId: UUID): Cas1SpaceBookingEntity = cas1SpaceBookingRepository.findByIdOrNull(spaceBookingId)
//    ?: throw NotFoundProblem(spaceBookingId, "Space Booking")
}
