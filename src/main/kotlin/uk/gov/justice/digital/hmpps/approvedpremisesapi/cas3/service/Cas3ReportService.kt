...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.cas3.repository.CasBedspaceOccupancyReportRepository
...
class Cas3ReportService(
  ...
  private val casBedspaceOccupancyReportRepository: CasBedspaceOccupancyReportRepository,
  ...
  fun createBedspaceOccupancyReport(properties: BedspaceOccupancyReportProperties, outputStream: OutputStream) {
    ...
    val bedspacesInScope = casBedspaceOccupancyReportRepository.findAllBedspaces(
      probationRegionId = properties.probationRegionId,
      startDate = properties.startDate,
      endDate = properties.endDate,
    )
    ...
    val bedspaceBookingsInScope = casBedspaceOccupancyReportRepository.findAllBookingsByOverlappingDate(
      probationRegionId = properties.probationRegionId,
      properties.startDate,
      properties.endDate,
    )
    ...
    val bedspaceBookingsCancellationInScope =
      casBedspaceOccupancyReportRepository.findAllBookingCancellationsByOverlappingDate(
        probationRegionId = properties.probationRegionId,
        properties.startDate,
        properties.endDate,
      )
    ...
    val bedspaceBookingsTurnaroundInScope = casBedspaceOccupancyReportRepository.findAllBookingTurnaroundByOverlappingDate(
      probationRegionId = properties.probationRegionId,
      properties.startDate,
      properties.endDate,
    )
    ...
    val voidBedspaceInScope = casBedspaceOccupancyReportRepository.findAllVoidBedspaceByOverlappingDate(
      probationRegionId = properties.probationRegionId,
      properties.startDate,
      properties.endDate,
    )
