...
data class ApprovedPremisesApplication(
  ...
  @field:Schema(description = "If true, caseManagerUserDetails will provide case manager details. Otherwise, applicantUserDetails can be used for case manager details")
