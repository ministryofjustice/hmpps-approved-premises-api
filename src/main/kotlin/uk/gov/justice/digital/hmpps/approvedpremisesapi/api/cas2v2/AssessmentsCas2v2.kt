...
interface AssessmentsCas2v2 {
    ...
    @Operation(
        ...
        description = """""",
        responses = [
            ApiResponse(responseCode = "200", description = "successful operation", content = [Content(schema = Schema(implementation = Cas2v2Assessment::class))]),
    ...
    fun assessmentsAssessmentIdGet(@Parameter(description = "ID of the assessment", required = true) @PathVariable("assessmentId") assessmentId: java.util.UUID): ResponseEntity<Cas2v2Assessment> {
    ...
    @Operation(
        ...
        description = """""",
        responses = [
            ApiResponse(responseCode = "200", description = "successful operation", content = [Content(schema = Schema(implementation = Cas2v2ApplicationNote::class))]),
            ApiResponse(responseCode = "404", description = "invalid assessmentId", content = [Content(schema = Schema(implementation = Problem::class))])
        ]
    )
    @RequestMapping(
    ...
    fun assessmentsAssessmentIdNotesPost(@Parameter(description = "ID of the assessment", required = true) @PathVariable("assessmentId") assessmentId: java.util.UUID,@Parameter(description = "the note to add", required = true) @RequestBody body: NewCas2v2ApplicationNote): ResponseEntity<Cas2v2ApplicationNote> {
    ...
    fun assessmentsAssessmentIdPut(@Parameter(description = "ID of the assessment", required = true) @PathVariable("assessmentId") assessmentId: java.util.UUID,@Parameter(description = "Information to update the assessment with", required = true) @RequestBody updateCas2v2Assessment: UpdateCas2v2Assessment): ResponseEntity<Cas2v2Assessment> {
        return getDelegate().assessmentsAssessmentIdPut(assessmentId, updateCas2v2Assessment)
    }
