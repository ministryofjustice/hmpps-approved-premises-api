...
class TimelineEventsTransformer(
  ...
  private fun addPrisonAndPomEvents(jpa: Cas2ApplicationEntity, timelineEvents: MutableList<Cas2TimelineEvent>) {
    val applicationAssignments = jpa.applicationAssignments.sortedBy { a -> a.createdAt }
