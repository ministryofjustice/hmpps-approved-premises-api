...
interface OutOfServiceBedsCas1Delegate {
   ...
   */
  fun premisesPremisesIdOutOfServiceBedsOutOfServiceBedIdCancellationsPost(
    premisesId: java.util.UUID,
   ...
   */
  fun premisesPremisesIdOutOfServiceBedsOutOfServiceBedIdGet(
    premisesId: java.util.UUID,
    outOfServiceBedId: java.util.UUID,
   ...
   */
  fun premisesPremisesIdOutOfServiceBedsOutOfServiceBedIdPut(
    premisesId: java.util.UUID,
    outOfServiceBedId: java.util.UUID,
   ...
   */
  fun premisesPremisesIdOutOfServiceBedsPost(
    premisesId: java.util.UUID,
