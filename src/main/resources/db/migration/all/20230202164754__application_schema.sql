INSERT INTO json_schemas (id, added_at, type, "schema") VALUES (
  '49df96e4-f1b6-4622-9355-729f5adaf042',
  NOW(),
  'APPROVED_PREMISES_APPLICATION',
'{
...
INSERT INTO approved_premises_application_json_schemas (json_schema_id, is_womens_json_logic_rule, is_pipe_json_logic_rule, target_location_json_logic_rule, release_type_json_logic_rule) VALUES
(
    '49df96e4-f1b6-4622-9355-729f5adaf042',
    '{"==": [1, 2]}', -- Always evaluates to false as Women's applications are not supported yet
    '{"==": [{"var": "type-of-ap.ap-type.type"}, "pipe"]}',
    '{"var": "location-factors.describe-location-factors.postcodeArea"}',
    '{"var": "basic-information.release-type.releaseType"}'
);
