...
DROP VIEW IF EXISTS cas_2_bail_application_summary CASCADE;
...
DROP TABLE IF EXISTS cas_2_bail_application_live_summary CASCADE;
DROP VIEW IF EXISTS cas_2_bail_application_live_summary CASCADE;
