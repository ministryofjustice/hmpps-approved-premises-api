ALTER TABLE cas_2_application_assignments DROP CONSTRAINT cas_2_application_assignments_allocated_pom_user_id_cas_2_fkey;
ALTER TABLE cas_2_application_notes DROP CONSTRAINT cas_2_application_notes_created_by_cas2_user_id_fkey;
ALTER TABLE cas_2_applications DROP CONSTRAINT cas_2_applications_created_by_cas2_user_id_fkey;
ALTER TABLE cas_2_status_updates DROP CONSTRAINT cas_2_status_updates_cas2_user_assessor_id_fkey;
ALTER TABLE cas_2_application_notes ALTER COLUMN created_by_cas2_user_id DROP NOT NULL;
ALTER TABLE cas_2_applications ALTER COLUMN created_by_cas2_user_id DROP NOT NULL;
ALTER TABLE cas_2_applications ALTER COLUMN service_origin DROP NOT NULL;
ALTER TABLE cas_2_assessments ALTER COLUMN service_origin DROP NOT NULL;
ALTER TABLE cas_2_status_updates ALTER COLUMN cas2_user_assessor_id DROP NOT NULL;
ALTER TABLE cas_2_users ALTER COLUMN service_origin DROP NOT NULL;
ALTER TABLE cas_2_users ALTER COLUMN is_active DROP NOT NULL;
ALTER TABLE cas_2_users ALTER COLUMN is_enabled DROP NOT NULL;
