-- ${flyway:timestamp}
-- ideally this would only be managed via the seed CSV files but removing the contents of this file breaks R__4_create_bookings_for_cas3 as they require the beds
