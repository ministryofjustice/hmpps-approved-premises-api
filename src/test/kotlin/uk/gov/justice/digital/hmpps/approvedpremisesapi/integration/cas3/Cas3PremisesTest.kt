...
class Cas3PremisesTest : IntegrationTestBase() {
  ...
  inner class GetPremisesSummary {
    ...
    private fun getListPremises(probationRegion: ProbationRegionEntity): List<TemporaryAccommodationPremisesEntity> {
      ...
      val premises = getPartialListPremises(
      ...
      val definitelyArchivedPremises = getPartialListPremises(
        probationRegion = probationRegion,
        probationDeliveryUnit = probationDeliveryUnit,
        localAuthorityArea = localAuthorityArea,
        dbSize = 1,
      ...
      val definitelyActivePremises = getPartialListPremises(
        probationRegion = probationRegion,
        probationDeliveryUnit = probationDeliveryUnit,
        localAuthorityArea = localAuthorityArea,
        dbSize = 1,
    ...
    private fun getPartialListPremises(
