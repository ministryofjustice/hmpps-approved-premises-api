package uk.gov.justice.digital.hmpps.approvedpremisesapi.cas2.unit.model.reference
...
class Cas2PersistedApplicationStatusFinderTest {
  ...
  inner class ServiceDifferentiation {
    ...
    fun `Requests for CAS2 service returns only CAS2 detail updates`() {
      ...
      // TODO besscerule As we have increased cas2 details to include cas2v2 these numbers have gone up
