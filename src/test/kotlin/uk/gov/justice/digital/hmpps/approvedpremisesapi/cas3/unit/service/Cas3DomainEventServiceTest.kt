...
class Cas3DomainEventServiceTest {
  ...
  @Test
  fun `getBedspaceArchiveOrUnarchiveEvents returns list of bedspace archive events`() {
    ...
    every { domainEventRepositoryMock.findArchivedOrUnarchivedBedspaceEvent(bedspaceId) } returns listOf(
      domainEventEntityYesterday,
      domainEventEntityToday,
      domainEventEntityTomorrow,
    )

    val event = cas3DomainEventService.getBedspaceArchiveOrUnarchiveEvents(bedspaceId)
