...
class Cas2HdcSarComplianceTest : Cas2SarTestBase() {
  ...
  companion object {
    ...
    const val GENERATED_API_RESPONSE_FILENAME = "cas2-hdc-expected-api-response.json.log"
    const val GENERATED_REPORT_FILENAME = "cas2-hdc-expected-report.html.log"
  }
