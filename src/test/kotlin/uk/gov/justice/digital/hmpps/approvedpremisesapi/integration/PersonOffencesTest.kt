...
class PersonOffencesTest : InitialiseDatabasePerClassTestBase() {
  @Autowired
  lateinit var offenseTransformer: OffenseTransformer
    ...
    givenAUser { userEntity, jwt ->
      givenAnOffender { offenderDetails, inmateDetails ->
        ...
        webTestClient.get()
          ...
          .expectBody()
          .json(
            objectMapper.writeValueAsString(offenseTransformer.transformToApi(activeConviction)),
          )
      }
    }
  }
    ...
    givenAUser { userEntity, jwt ->
      givenAnOffender { offenderDetails, _ ->
        ...
        webTestClient.get()
          ...
          .expectBody()
          .json(
            objectMapper.writeValueAsString(offenseTransformer.transformToApi(caseDetail)),
          )
      }
    }
  }
