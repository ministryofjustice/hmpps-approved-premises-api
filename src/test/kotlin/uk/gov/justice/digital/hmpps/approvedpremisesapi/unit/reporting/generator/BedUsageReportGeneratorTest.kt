...
class BedUsageReportGeneratorTest {
  ...
  fun `Booking rows are correctly generated`() {
    ...
    assertThat(result[0][BedUsageReportRow::bedspaceRef]).isEqualTo(temporaryAccommodationBed.name)
    ...
    assertThat(result[0][BedUsageReportRow::durationOfBookingDays]).isEqualTo(3)
  ...
  fun `Turnaround rows are correctly generated`() {
    ...
    assertThat(result[1][BedUsageReportRow::bedspaceRef]).isEqualTo(temporaryAccommodationBed.name)
    ...
    assertThat(result[1][BedUsageReportRow::durationOfBookingDays]).isEqualTo(2)
