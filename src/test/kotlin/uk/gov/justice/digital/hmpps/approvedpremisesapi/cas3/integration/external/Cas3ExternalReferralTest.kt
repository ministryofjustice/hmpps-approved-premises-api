        ...
        givenASingleAccommodationServiceClientCredentialsApiCall { clientCredentialsJwt ->
          ...
          val expectedReferrals = listOf(
            Cas3ReferralHistory(
              ...
              referralUrl = "http://frontend.cas3/applications/${assessment1.application.id}/full",
            ),
            Cas3ReferralHistory(
              id = assessment2.id,
              ...
              placementAddress = "10 Test Street, London, SW1A 1AA",
              placementStatus = Cas3BookingStatus.provisional.value,
              referralUrl = "http://frontend.cas3/applications/${assessment2.application.id}/full",
            ),
            Cas3ReferralHistory(
              id = assessment3.id,
              ...
              placementAddress = "10 Test Street, London, SW1A 1AA",
              placementStatus = Cas3BookingStatus.provisional.value,
              referralUrl = "http://frontend.cas3/applications/${assessment3.application.id}/full",
            ),
            Cas3ReferralHistory(
              id = assessment4.id,
              ...
              placementAddress = "10 Test Street, London, SW1A 1AA",
              placementStatus = Cas3BookingStatus.provisional.value,
              referralUrl = "http://frontend.cas3/applications/${assessment4.application.id}/full",
            ),
            Cas3ReferralHistory(
              id = assessment5.id,
              ...
              placementAddress = "10 Test Street, London, SW1A 1AA",
              placementStatus = Cas3BookingStatus.provisional.value,
              referralUrl = "http://frontend.cas3/applications/${assessment5.application.id}/full",
            ),
          )
