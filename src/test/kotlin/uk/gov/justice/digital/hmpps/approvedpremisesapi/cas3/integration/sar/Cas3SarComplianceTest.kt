...
class Cas3SarComplianceTest : Cas3SarTestBase() {
  ...
  private fun setupTestData() {
    ...
    assessmentReferralHistorySystemNoteEntity(assessment, user)
    assessmentReferralHistoryUserNoteEntity(assessment, user)
    ...
    setupDomainEvents(offenderDetails, application, assessment, assessor, booking)
  }
