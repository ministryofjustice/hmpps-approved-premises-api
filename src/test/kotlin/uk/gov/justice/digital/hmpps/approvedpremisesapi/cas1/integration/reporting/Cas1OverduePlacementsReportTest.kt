...
class Cas1OverduePlacementsReportTest : InitialiseDatabasePerClassTestBase() {
  ...
  @ParameterizedTest
  @EnumSource(value = UserRole::class, names = ["CAS1_REPORT_VIEWER", "CAS1_REPORT_VIEWER_WITH_PII", "CAS1_OPERATIONAL_REPORTS_VIEWER", "CAS1_JANITOR"], mode = EnumSource.Mode.EXCLUDE)
  fun `Get overdue placements report requires report viewer role`(role: UserRole) {
  ...
  @ParameterizedTest
  @EnumSource(value = UserRole::class, names = ["CAS1_REPORT_VIEWER", "CAS1_REPORT_VIEWER_WITH_PII", "CAS1_OPERATIONAL_REPORTS_VIEWER", "CAS1_JANITOR"], mode = EnumSource.Mode.INCLUDE)
