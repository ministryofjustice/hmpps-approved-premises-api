...
open class Cas1SarTestBase : SubjectAccessRequestServiceTestBase() {
  ...
  companion object {
    ...
    val CAS1_PLACEMENT_APPLICATION_DATA by lazy { readResource("$CAS1_DATA_PATH/placement_application_data.json") }
  }
  ...
  protected fun placementRequirementEntity(
    application: ApprovedPremisesApplicationEntity,
    assessment: ApprovedPremisesAssessmentEntity,
    desirableCriteria: List<uk.gov.justice.digital.hmpps.approvedpremisesapi.jpa.entity.cas1.Cas1CharacteristicEntity> = listOf(characteristicEntity()),
    essentialCriteria: List<uk.gov.justice.digital.hmpps.approvedpremisesapi.jpa.entity.cas1.Cas1CharacteristicEntity> = listOf(characteristicEntity()),
