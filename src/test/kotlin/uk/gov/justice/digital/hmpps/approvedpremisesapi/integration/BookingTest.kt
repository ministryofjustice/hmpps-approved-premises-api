        ...
        `Given a User` { applicant, _ ->
          `Given an Offender` { offenderDetails, _ ->
            ...
            webTestClient.post()
              ...
              .jsonPath("$.keyWorker").doesNotExist()
              .jsonPath("$.status").isEqualTo("awaiting-arrival")
              .jsonPath("$.arrival").doesNotExist()
              .jsonPath("$.departure").doesNotExist()
              .jsonPath("$.nonArrival").doesNotExist()
    ...
    `Given a User`(roles = listOf(UserRole.CAS3_ASSESSOR)) { userEntity, jwt ->
      `Given an Offender` { offenderDetails, inmateDetails ->
        ...
        webTestClient.post()
          ...
          .jsonPath("$.nonArrival").doesNotExist()
          .jsonPath("$.cancellation").doesNotExist()
          .jsonPath("$.confirmation").doesNotExist()
    ...
    `Given a User`(roles = listOf(UserRole.CAS3_ASSESSOR)) { userEntity, jwt ->
      `Given an Offender` { offenderDetails, inmateDetails ->
        ...
        webTestClient.post()
          ...
          .jsonPath("$.bed.id").isEqualTo(bed.id.toString())
          .jsonPath("$.bed.name").isEqualTo("test-bed")
          .jsonPath("$.assessmentId").doesNotExist()
      }
    }
  }
    ...
    `Given a User`(roles = listOf(UserRole.CAS3_ASSESSOR)) { userEntity, jwt ->
      `Given an Offender` { offenderDetails, inmateDetails ->
        ...
        webTestClient.post()
          ...
          .jsonPath("$.destinationProvider").doesNotExist()
