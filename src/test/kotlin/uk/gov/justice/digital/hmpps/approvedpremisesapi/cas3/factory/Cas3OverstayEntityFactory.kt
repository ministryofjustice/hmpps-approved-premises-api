...
class Cas3OverstayEntityFactory : Factory<Cas3OverstayEntity> {
  ...
  private var isAuthorised: Yielded<Boolean> = { true }
  ...
  fun withIsAuthorised(isAuthorised: Boolean) = apply {
  ...
  override fun produce(): Cas3OverstayEntity = Cas3OverstayEntity(
    id = this.id(),
