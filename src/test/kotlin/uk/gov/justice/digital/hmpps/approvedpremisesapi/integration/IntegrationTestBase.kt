...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.repository.LostBedCancellationsTestRepository
...
abstract class IntegrationTestBase {
  ...
  @Autowired
  lateinit var lostBedCancellationsRepository: LostBedCancellationsTestRepository
  ...
  lateinit var lostBedCancellationsEntityFactory: PersistedFactory<LostBedCancellationEntity, UUID, LostBedCancellationEntityFactory>
  ...
  fun setupFactories() {
    ...
    lostBedCancellationsEntityFactory = PersistedFactory({ LostBedCancellationEntityFactory() }, lostBedCancellationsRepository)
