...
class Cas1SpaceBookingTransformerTest {
  ...
  inner class TransformJpaToApi {
    ...
    fun `Space booking is transformed correctly`() {
      ...
      assertThat(result.actualArrivalTime).isEqualTo("11:25:10")
      ...
      assertThat(result.actualDepartureTime).isEqualTo("23:00:00")
      ...
      assertThat(result.status).isEqualTo(Cas1SpaceBookingSummaryStatus.NOT_ARRIVED)
    }
