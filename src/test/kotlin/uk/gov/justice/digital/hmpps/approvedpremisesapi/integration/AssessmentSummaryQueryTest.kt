  ...
  private fun assertForAssessmentSummary(summary: DomainAssessmentSummary, assessment: AssessmentEntity) {
    ...
    when (application) {
      is ApprovedPremisesApplicationEntity -> {
        ...
        assertThat(jsonMapper.readTree(summary.riskRatings)).isEqualTo(jsonMapper.readTree("""{"roshRisks":{"status":"NotFound","value":null},"mappa":{"status":"NotFound","value":null},"tier":{"status":"NotFound","value":null},"flags":{"status":"NotFound","value":null}}"""))
      }
