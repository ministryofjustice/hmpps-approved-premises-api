...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.cas1.dto.Cas1ApplicationExpiredManuallyPayload
...
class Cas1DomainEventDescriberTest {
  ...
  @Nested
  inner class ApplicationAssessed {
    @ParameterizedTest
  ...
  @Nested
  inner class BookingKeyworkerAssigned {
    @Test
  ...
  @Nested
  inner class ApplicationExpiredManually {
    @Test
  ...
  @Nested
  inner class AssessmentAppealed {
    @ParameterizedTest
  ...
  @Nested
  inner class MatchRequestWithdrawn {
    @Test
  ...
  @Nested
  inner class AssessmentInfoRequested {
    @Test
