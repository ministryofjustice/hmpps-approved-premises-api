...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.factory.events.Cas1DomainEventNamedIdFactory
        ...
        builder =
        {
          PlacementAppealCreatedEnvelope(
            ...
            eventDetails = PlacementAppealCreatedFactory()
              ...
              .withBookingId(UUID.randomUUID())
              .withAppealReason(
                Cas1DomainEventNamedIdFactory()
                  .withName("The appeal name")
                  .produce(),
              )
              .withArrivalOn(LocalDate.of(2015, 12, 1))
              .withDepartureOn(LocalDate.of(2015, 12, 2))
