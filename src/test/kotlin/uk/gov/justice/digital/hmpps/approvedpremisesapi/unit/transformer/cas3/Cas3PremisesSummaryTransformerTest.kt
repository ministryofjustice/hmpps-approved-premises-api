...
class Cas3PremisesSummaryTransformerTest {
  ...
  @Test
  fun `transformDomainToCas3BedspaceSummary transforms the FlatTemporaryAccommodationPremisesSummary and bedspaces into a Cas3BedspacesSummary`() {
    ...
    assertThat(result).isEqualTo(
      Cas3BedspaceSummary(
        id = domainPremisesSummary.bedspacesId!!,
        reference = domainPremisesSummary.bedspacesReference!!,
        status = domainPremisesSummary.bedspacesStatus!!,
      ),
    )
  }
