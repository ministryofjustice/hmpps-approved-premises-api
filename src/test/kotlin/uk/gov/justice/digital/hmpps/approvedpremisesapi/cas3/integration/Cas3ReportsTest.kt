...
class Cas3ReportsTest : IntegrationTestBase() {
  ...
  inner class GetBedUtilReport {
    ...
    fun `Get bed utilisation report returns OK with correct body`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { userEntity, jwt ->
        givenAnOffender { offenderDetails, inmateDetails ->
          ...
          val localAuthorityArea: LocalAuthorityAreaEntity = localAuthorityEntityFactory.produceAndPersist()

          val expectedReportRows = ArrayList<BedUtilisationReportRow>()
    ...
    private fun setupBedUtilisationReportData(
      ...
      return BedUtilisationReportRow(
        probationRegion = probationRegion.name,
        pdu = probationDeliveryUnit.name,
  ...
  inner class GetBookingGapReport {
    ...
    fun `Get booking gap report for single booking within report period returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, inmateDetails ->
          ...
          val bed1 = createBed(premises, "bed1", bedStart, bedEnd)
          createBooking(
            premises,
            bed1,
            offenderDetails.otherIds.crn,
    ...
    fun `Get booking gap report for multiple bookings for the same bedspace returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, inmateDetails ->
          ...
          val bed2 = createBed(premises, "bed2", bedStart, bedEnd)
          createBooking(
            premises,
            bed2,
            offenderDetails.otherIds.crn,
    ...
    fun `Get booking gap report for bedspace start date after report start date returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, inmateDetails ->
          ...
          val bed1 = createBed(premises, "bed1", LocalDate.parse("2024-04-10"), bedEnd)
          createBooking(
            premises,
            bed1,
            offenderDetails.otherIds.crn,
    ...
    fun `Get booking gap report for bedspace end date before report end date returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, inmateDetails ->
          ...
          val bed1 = createBed(premises, "bed1", bedStart, LocalDate.parse("2024-04-20"))
          createBooking(
            premises,
            bed1,
            offenderDetails.otherIds.crn,
    ...
    @Test
    fun `Get booking gap report for bed with both booking and void within report period returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, inmateDetails ->
          val reportStartDate = LocalDate.of(2024, 4, 1)
          val reportEndDate = LocalDate.of(2024, 4, 30)
      ...
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, inmateDetails ->
          ...
          val cancellationReason =
            cancellationReasonEntityFactory.produceAndPersist { withServiceScope("temporary-accommodation") }
          cancellationEntityFactory.produceAndPersist {
    ...
    @Test
    fun `Get booking gap report with multiple voids within the report prediod returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, inmateDetails ->
          val reportStartDate = LocalDate.of(2024, 4, 1)
          val reportEndDate = LocalDate.of(2024, 4, 30)
    ...
    @Test
    fun `Get booking gap report clips gaps strictly to report window returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, _ ->

          govUKBankHolidaysAPIMockSuccessfullCallWithEmptyResponse()

          val reportStartDate = LocalDate.of(2025, 9, 1)
          val reportEndDate = LocalDate.of(2025, 9, 30)
          ...
          val bedStart = LocalDate.parse("2025-04-01")
          val bedEnd = LocalDate.parse("2025-12-31")
          ...
          cas3VoidBedspaceEntityFactory.produceAndPersist {
            withBed(bed1)
            withStartDate(LocalDate.parse("2025-10-09"))
            withEndDate(LocalDate.parse("2025-11-09"))
    ...
    @Test
    fun `Get booking gap report with booking and overlapping void periods returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, _ ->

          govUKBankHolidaysAPIMockSuccessfullCallWithEmptyResponse()

          val reportStartDate = LocalDate.of(2024, 9, 1)
          val reportEndDate = LocalDate.of(2024, 9, 30)
          ...
          cas3VoidBedspaceEntityFactory.produceAndPersist {
            withBed(bed1)
            withStartDate(LocalDate.parse("2024-07-17"))
            withEndDate(LocalDate.parse("2024-12-16"))
            withCostCentre(Cas3CostCentre.SUPPLIER)
            withYieldedReason { cas3VoidBedspaceReasonEntityFactory.produceAndPersist() }
          }
          ...
          cas3VoidBedspaceEntityFactory.produceAndPersist {
            withBed(bed1)
            withStartDate(LocalDate.parse("2024-06-27")) // overlaps inside the first void
            withEndDate(LocalDate.parse("2099-10-01"))
            withCostCentre(Cas3CostCentre.SUPPLIER)
            withYieldedReason { cas3VoidBedspaceReasonEntityFactory.produceAndPersist() }
          }
    ...
    @Test
    fun `Get booking gap report with booking over whole report period returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, _ ->
    ...
    @Test
    fun `Get booking gap report with void over whole report period returns OK`() {
      givenAUser(roles = listOf(CAS3_ASSESSOR)) { user, jwt ->
        givenAnOffender { offenderDetails, _ ->
          ...
          cas3VoidBedspaceEntityFactory.produceAndPersist {
            withBed(bed1)
            withStartDate(LocalDate.parse("2024-08-15"))
            withEndDate(LocalDate.parse("2024-10-15"))
            withCostCentre(Cas3CostCentre.SUPPLIER)
            withYieldedReason { cas3VoidBedspaceReasonEntityFactory.produceAndPersist() }
          }
  ...
  private fun createBed(
    ...
    bed.createdAt = startDate.atStartOfDay().atOffset(ZoneOffset.UTC)
    bedRepository.save(bed)
