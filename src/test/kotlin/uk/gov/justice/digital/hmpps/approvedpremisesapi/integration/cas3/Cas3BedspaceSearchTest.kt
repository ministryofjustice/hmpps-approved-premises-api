    ...
    fun `Searching for men only bedspaces returns bedspaces suitable for men`() {
      givenAUser(
        ...
        givenSomeOffenders { offenderSequence ->
          ...
          val caseSummaryOne = CaseSummaryFactory()
          ...
          bookingEntityFactory.produceAndPersist {
            ...
            withDepartureDate(LocalDate.parse("2025-06-23"))
          ...
          apDeliusContextAddListCaseSummaryToBulkResponse(listOf(caseSummaryOne, caseSummaryTwo))
    ...
    fun `Searching for women only bedspaces returns bedspaces suitable for women`() {
      givenAUser(
        ...
        givenSomeOffenders { offenderSequence ->
          ...
          val offenderDetailsThree = offenders.drop(2).first().first
          val caseSummaryThree = CaseSummaryFactory()
            .fromOffenderDetails(offenderDetailsThree)
            .withGender("Female")
            .produce()
          ...
          apDeliusContextAddListCaseSummaryToBulkResponse(listOf(caseSummaryTwo, caseSummaryThree))
