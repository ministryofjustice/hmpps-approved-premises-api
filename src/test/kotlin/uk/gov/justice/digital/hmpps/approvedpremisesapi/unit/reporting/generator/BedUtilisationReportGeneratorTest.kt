...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.util.createTestBedUtilisationBookingReportData
import uk.gov.justice.digital.hmpps.approvedpremisesapi.util.createTestBedUtilisationLostBedReportData
...
class BedUtilisationReportGeneratorTest {
  ...
  fun `Only results for beds from the specified service are returned in the report`() {
    ...
    val bedUtilisationBedspaceReportData = createTestBedUtilisationBedspaceReportData(temporaryAccommodationBed)
    val bedUtilisationLostBedReportData = createTestBedUtilisationLostBedReportData(temporaryAccommodationLostBed)
  ...
  fun `Only results for beds from the approved premises service are returned in the report for 1 months`() {
    ...
    val bedUtilisationBedspaceReportData = createTestBedUtilisationBedspaceReportData(approvedPremisesBed)
    val bedUtilisationLostBedReportData = createTestBedUtilisationLostBedReportData(approvedPremisesLostBed)
    val bedUtilisationReportData =
      BedUtilisationReportData(bedUtilisationBedspaceReportData, listOf(), listOf(bedUtilisationLostBedReportData))
  ...
  fun `Only results for beds from the specified probation region are returned in the report`() {
    ...
    val bedUtilisationBedspaceReportData =
      createTestBedUtilisationBedspaceReportData(temporaryAccommodationBedInProbationRegion)
    val bedUtilisationLostBedReportData =
      createTestBedUtilisationLostBedReportData(temporaryAccommodationLostBedInProbationArea)
    val bedUtilisationReportData =
      BedUtilisationReportData(bedUtilisationBedspaceReportData, listOf(), listOf(bedUtilisationLostBedReportData))
  ...
  fun `Results for beds from all probation regions are returned in the report if no probation region ID is provided`() {
    ...
    val bedUtilisationBedOutsideProbationRegionReportData =
      createTestBedUtilisationBedspaceReportData(temporaryAccommodationBedOutsideProbationRegion)
    val bedUtilisationLostBedOutsideProbationRegionReportData =
      createTestBedUtilisationLostBedReportData(temporaryAccommodationLostBedOutsideProbationArea)
  ...
  fun `bookedDaysActiveAndClosed shows the total number of days within the month for Bookings that are marked as arrived`() {
    ...
    val relevantBookingStraddlingStartOfMonthReportData =
      createTestBedUtilisationBookingReportData(relevantBookingStraddlingStartOfMonth)
    val relevantBookingStraddlingEndOfMonthReportData =
      createTestBedUtilisationBookingReportData(relevantBookingStraddlingEndOfMonth)
  ...
  fun `voidDays shows the total number of days in the month for voids`() {
    ...
    val relevantVoidStraddlingStartOfMonthReportData =
      createTestBedUtilisationLostBedReportData(relevantVoidStraddlingStartOfMonth)
    val relevantVoidStraddlingEndOfMonthReportData =
      createTestBedUtilisationLostBedReportData(relevantVoidStraddlingEndOfMonth)
    val bedUtilisationReportData = BedUtilisationReportData(
      bedUtilisationBedspaceReportData,
      listOf(),
