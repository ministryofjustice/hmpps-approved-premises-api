...
class Cas1DomainEventsFactory(val jsonMapper: ObjectMapper) {
  ...
  fun createEnvelopeForLatestSchemaVersion(
    ...
    val eventDetails = when (type) {
      ...
      DomainEventType.APPROVED_PREMISES_APPLICATION_EXPIRED_MANUALLY -> ApplicationExpiredManuallyFactory().produce()
