...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.cas2hdc.service.Cas2DomainEventListener
    ...
    givenACas2PomUser { oldUserEntity, _ ->
      givenACas2PomUser { newUserEntity, _ ->
        givenAnOffender { offenderDetails, _ ->
          ...
          verify(emailNotificationService, after(5000).times(0)).sendCas2Email(any(), any(), any())
        }
      }
    }
  }
