...
class TemporaryAccommodationAssessmentJsonSchemaEntityFactory : Factory<TemporaryAccommodationAssessmentJsonSchemaEntity> {
  ...
  override fun produce(): TemporaryAccommodationAssessmentJsonSchemaEntity = TemporaryAccommodationAssessmentJsonSchemaEntity(
    id = this.id(),
