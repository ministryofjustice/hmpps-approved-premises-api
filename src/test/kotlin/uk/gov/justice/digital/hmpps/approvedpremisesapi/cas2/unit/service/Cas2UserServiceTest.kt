...
class Cas2UserServiceTest {
  ...
  inner class GetCurrentUserTest {
    ...
    fun `returns success when user is Delius user`() {
      ...
      val typedDeliusUser = cas2UserTransformer.transformJpaToTypedDeliusUser(deliusUser, staffDetail)
      ...
      every { mockCas2UserTransformer.transformJpaToTypedDeliusUser(deliusUser, staffDetail) } returns typedDeliusUser
    ...
    fun `returns success when user is Nomis user`() {
      ...
      val typedNomisUser = cas2UserTransformer.transformJpaToTypedNomisUser(nomisUser)
      ...
      every { mockCas2UserTransformer.transformJpaToTypedNomisUser(nomisUser) } returns typedNomisUser
