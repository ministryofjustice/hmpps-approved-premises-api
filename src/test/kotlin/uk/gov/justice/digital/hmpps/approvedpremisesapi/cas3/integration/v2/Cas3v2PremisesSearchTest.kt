...
class Cas3v2PremisesSearchTest : Cas3IntegrationTestBase() {
  ...
  private fun createPremises(probationRegion: ProbationRegionEntity): List<Cas3PremisesEntity> {
    ...
    premises.forEach { prem -> {
      cas3BedspacesRepository.save(Cas3BedspaceEntityFactory().onlineBedspace(prem))
      cas3BedspacesRepository.save(Cas3BedspaceEntityFactory().upcomingBedspace(prem))
      cas3BedspacesRepository.save(Cas3BedspaceEntityFactory().archivedBedspace(prem))
    }}
    return premises
  }
