...
class SeedTemporaryAccommodationSmokeTest : SeedTestBase() {
  ...
  fun `Temporary Accommodation premises and bedspaces can be seeded using realistic data`() {
    ...
    seed(
      ...
      """
        Property reference,Bedspace reference,Single bed?,Double bed?,Shared kitchen?,Floor level access?,Lift access?,Wheelchair accessible?,Not suitable for RSO?,Not suitable for arson offenders?,Optional notes about the bedspace,Email address,Start Date
        WED,WED-1,TRUE,FALSE,FALSE,TRUE,TRUE,TRUE,FALSE,FALSE,"Bedspace is accessible for wheelchair users, as has ground floor access and a lift up to the property.",wed@email.com,"2025-01-01"
