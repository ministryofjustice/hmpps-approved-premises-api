...
import uk.gov.justice.digital.hmpps.approvedpremisesapi.api.events.cas1.model.BookingExtended
 ...
 * @param eventDetails 
 */
data class BookingExtendedEnvelope(
    ...
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("eventDetails", required = true) val eventDetails: BookingExtended
) {
