        ...
        getRequest().ifPresent { request ->
            for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "[ {  \"dateCreated\" : \"2000-01-23\",  \"expired\" : true,  \"dateExpires\" : \"2000-01-23\",  \"active\" : true,  \"comment\" : \"comment\",  \"alertId\" : 0}, {  \"dateCreated\" : \"2000-01-23\",  \"expired\" : true,  \"dateExpires\" : \"2000-01-23\",  \"active\" : true,  \"comment\" : \"comment\",  \"alertId\" : 0} ]")
                    break
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
