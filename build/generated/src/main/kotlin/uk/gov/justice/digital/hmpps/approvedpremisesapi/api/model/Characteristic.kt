...
data class Characteristic(
    ...
    */
    enum class ServiceScope(val value: kotlin.String) {
        ...
        @JsonProperty("approved-premises") approvedMinusPremises("approved-premises"),
        @JsonProperty("temporary-accommodation") temporaryMinusAccommodation("temporary-accommodation"),
        @JsonProperty("*") star("*")
    }
    ...
    */
    enum class ModelScope(val value: kotlin.String) {
        ...
        @JsonProperty("premises") premises("premises"),
