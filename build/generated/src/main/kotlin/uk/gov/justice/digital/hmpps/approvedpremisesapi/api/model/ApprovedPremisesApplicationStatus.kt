...
enum class ApprovedPremisesApplicationStatus(val value: kotlin.String) {
    ...
    @JsonProperty("awaitingAssesment") awaitingAssesment("awaitingAssesment"),
    @JsonProperty("unallocatedAssesment") unallocatedAssesment("unallocatedAssesment"),
    @JsonProperty("assesmentInProgress") assesmentInProgress("assesmentInProgress"),
    @JsonProperty("awaitingPlacement") awaitingPlacement("awaitingPlacement"),
    @JsonProperty("placementAllocated") placementAllocated("placementAllocated"),
    ...
    @JsonProperty("pendingPlacementRequest") pendingPlacementRequest("pendingPlacementRequest"),
