...
interface PremisesCas1Delegate {
    ...
    fun getCapacity(premisesId: java.util.UUID,
        ...
        endDate: java.time.LocalDate): ResponseEntity<Cas1PremiseCapacity> {
        getRequest().ifPresent { request ->
            for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"premise\" : {    \"managerDetails\" : \"managerDetails\",    \"overbookingSummary\" : [ {      \"startInclusive\" : \"2022-07-28\",      \"endInclusive\" : \"2022-07-29\"    }, {      \"startInclusive\" : \"2022-07-28\",      \"endInclusive\" : \"2022-07-29\"    } ],    \"apArea\" : {      \"identifier\" : \"LON\",      \"name\" : \"Yorkshire & The Humber\",      \"id\" : \"cd1c2d43-0b0b-4438-b0e3-d4424e61fb6a\"    },    \"availableBeds\" : 20,    \"name\" : \"Hope House\",    \"postcode\" : \"LS1 3AD\",    \"supportsSpaceBookings\" : true,    \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",    \"apCode\" : \"NEHOPE1\",    \"bedCount\" : 22,    \"outOfServiceBeds\" : 2  },  \"endDate\" : \"2000-01-23\",  \"startDate\" : \"2000-01-23\",  \"capacity\" : [ {    \"date\" : \"2000-01-23\",    \"totalBedCount\" : 0,    \"availableBedCount\" : 6,    \"characteristicAvailability\" : [ {      \"bookingsCount\" : 5,      \"availableBedsCount\" : 5,      \"characteristic\" : \"acceptsChildSexOffenders\"    }, {      \"bookingsCount\" : 5,      \"availableBedsCount\" : 5,      \"characteristic\" : \"acceptsChildSexOffenders\"    } ],    \"bookingCount\" : 1  }, {    \"date\" : \"2000-01-23\",    \"totalBedCount\" : 0,    \"availableBedCount\" : 6,    \"characteristicAvailability\" : [ {      \"bookingsCount\" : 5,      \"availableBedsCount\" : 5,      \"characteristic\" : \"acceptsChildSexOffenders\"    }, {      \"bookingsCount\" : 5,      \"availableBedsCount\" : 5,      \"characteristic\" : \"acceptsChildSexOffenders\"    } ],    \"bookingCount\" : 1  } ]}")
                    break
                }
    ...
    fun getDaySummary(premisesId: java.util.UUID,
        ...
        bookingsSortBy: Cas1SpaceBookingDaySummarySortField?): ResponseEntity<Cas1PremiseDaySummary> {
        getRequest().ifPresent { request ->
            for (mediaType in MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"spaceBookings\" : [ {    \"essentialCharacteristics\" : [ \"hasEnSuite\", \"hasEnSuite\" ],    \"tier\" : \"tier\",    \"person\" : {      \"personType\" : \"FullPersonSummary\",      \"crn\" : \"crn\"    },    \"canonicalArrivalDate\" : \"2000-01-23\",    \"canonicalDepartureDate\" : \"2000-01-23\",    \"releaseType\" : \"releaseType\",    \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"  }, {    \"essentialCharacteristics\" : [ \"hasEnSuite\", \"hasEnSuite\" ],    \"tier\" : \"tier\",    \"person\" : {      \"personType\" : \"FullPersonSummary\",      \"crn\" : \"crn\"    },    \"canonicalArrivalDate\" : \"2000-01-23\",    \"canonicalDepartureDate\" : \"2000-01-23\",    \"releaseType\" : \"releaseType\",    \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"  } ],  \"previousDate\" : \"2000-01-23\",  \"forDate\" : \"2000-01-23\",  \"nextDate\" : \"2000-01-23\",  \"capacity\" : {    \"date\" : \"2000-01-23\",    \"totalBedCount\" : 0,    \"availableBedCount\" : 6,    \"characteristicAvailability\" : [ {      \"bookingsCount\" : 5,      \"availableBedsCount\" : 5,      \"characteristic\" : \"acceptsChildSexOffenders\"    }, {      \"bookingsCount\" : 5,      \"availableBedsCount\" : 5,      \"characteristic\" : \"acceptsChildSexOffenders\"    } ],    \"bookingCount\" : 1  },  \"outOfServiceBeds\" : [ {    \"reason\" : {      \"name\" : \"Double Room with Single Occupancy - Other (Non-FM)\",      \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",      \"isActive\" : true    },    \"characteristics\" : [ \"acceptsChildSexOffenders\", \"acceptsChildSexOffenders\" ],    \"endDate\" : \"2000-01-23\",    \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",    \"startDate\" : \"2000-01-23\"  }, {    \"reason\" : {      \"name\" : \"Double Room with Single Occupancy - Other (Non-FM)\",      \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",      \"isActive\" : true    },    \"characteristics\" : [ \"acceptsChildSexOffenders\", \"acceptsChildSexOffenders\" ],    \"endDate\" : \"2000-01-23\",    \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\",    \"startDate\" : \"2000-01-23\"  } ]}")
                    break
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    ApiUtil.setExampleResponse(request, "application/json", "{  \"instance\" : \"f7493e12-546d-42c3-b838-06c12671ab5b\",  \"detail\" : \"You provided invalid request parameters\",  \"type\" : \"https://example.net/validation-error\",  \"title\" : \"Invalid request parameters\",  \"status\" : 400}")
